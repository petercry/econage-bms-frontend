...
<script>
  ...
  import {editModelNode,getModelNodeSingle} from '../../service/service'
  ...
  export default {
      ...
      methods: {
             ...
             getSingle(){
                getModelNodeSingle(this.baseInfo.id).then((response)=>{
                        this.baseInfo.business = response.data.business;
                        this.baseInfo.name = response.data.name;
                        this.baseInfo.comments = response.data.comments;
                })
            },
            ...
            createFunc(){
                  ...
                  this.$refs['form'].validate((valid) => {
                      if (valid) {
                            ...
                            editModelNode(that.baseInfo).then((response)=>{
