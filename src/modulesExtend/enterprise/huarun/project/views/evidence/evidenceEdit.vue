...
<script>
  ...
  import {updateEvidence,getEnumSelectEnabled,getEvidenceSingle} from '../../service/service'
            ...
            createFunc(){
                  ...
                  this.$refs['form'].validate((valid) => {
                      if (valid) {
                            ...
                            updateEvidence(that.baseInfo).then((response)=>{
