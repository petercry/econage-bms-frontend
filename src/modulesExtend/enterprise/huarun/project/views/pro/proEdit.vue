...
<script>
  ...
  import {getRegionVO,updatePro,getProSingle} from '../../service/service'
  ...
  export default {
      ...
      methods: {
            getProSingleFunc(){
                getProSingle(this.baseInfo.id).then((response)=>{
                        this.baseInfo.business = response.data.business;
                        this.baseInfo.code = response.data.code;
                        this.baseInfo.name = response.data.name;
                        this.baseInfo.region = response.data.region;
                        this.baseInfo.regionCompany = response.data.regionCompany;
                        this.baseInfo.capacity = response.data.capacity;
                        this.baseInfo.fanList = response.data.fanList;
            ...
            createFunc(){
                  ...
                  this.$refs['form'].validate((valid) => {
                      if (valid) {
                            ...
                            updatePro(that.baseInfo).then((response)=>{
