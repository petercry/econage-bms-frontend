<template>
 ...
 <div class="projectDetail">
    ...
    <el-tab-pane label="项目文档信息">
      <fileInfo></fileInfo>
    </el-tab-pane>
    <el-tab-pane label="项目预算信息">
     <yuSuan></yuSuan>
    </el-tab-pane>
    <el-tab-pane label="项目过程信息">
      <processInfo></processInfo>
    </el-tab-pane>
    <el-tab-pane label="项目评分信息">
       <scoreInfo></scoreInfo>
    </el-tab-pane>
    <el-tab-pane label="项目采购合同信息">
      <heTong></heTong>
    </el-tab-pane>
    </el-tabs>
      </eco-content>
...
import yuSuan from './components/yuSuan.vue'
 ...
 methods:{
    goBack(){
       if(sysEnv!==1){
          ...
          let tabObj = {};
          tabObj.desc = '项目库'
          let goPage = "flowManage/index.html#/project";
          tabObj.r_func = "{menuTarget:'IFRAME',tabKey:'project',href_link:'" + goPage + "'}";
          tabObj.reload = true;
          tabObj.clearIframe = true;
          EcoUtil.getSysvm().doTab(tabObj);
          let that=this
          setTimeout(() => {
              window.parent.window.sysvm.removeTab('projectDetail' + that.id);
          }, 100);
       }
    }
 }
