...
export default{
  ...
  created(){
    this.pageInfo.total=data.projectData.length
    this.listData=data.projectData
    //   this.listData=data.projectData.filter((item=>{
  ...
  methods: {
    ...
    goDetail(id){
      if(sysEnv!==1){
        ...
        let tabObj = {};
        tabObj.desc = '项目详情'
        let goPage = "flowManage/index.html#/projectDetail" + '/' +id;
        tabObj.r_func = "{menuTarget:'IFRAME',tabKey:'projectDetail" + id + "',href_link:'" + goPage + "'}"
        tabObj.reload = true;
