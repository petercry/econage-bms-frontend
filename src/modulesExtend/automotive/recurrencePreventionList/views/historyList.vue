...
<script>
    ...
    import {recurrencePreventionArchiveList} from '../service/service.js'
    export default {
        name:'historyList',
        data(){
            return {
        ...
        methods:{
            openFlowList(id,type){
                ...
                let url = '/recurrencePreventionList/index.html#/flowHistory/'+id+'/'+type;
            ...
            recurrencePreventionArchiveList(params).then(res=>{
