...
<script>
  ...
  export default {
      ...
      methods: {
          ...mapActions(['setStatus','setOperate','setTypeList','setNatureList','setVehicleList','setAuthenticationList','setAplicableModelsList','setPowerType','setStandardState','setStatusSet']),
          /*初始化主题*/
          initTheme(){
