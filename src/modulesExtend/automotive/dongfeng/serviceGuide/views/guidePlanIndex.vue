...
<div class="guideIndex">
    ...
    <div class="header-input" v-show="searchShow">
        <el-form ref="form" :model="form" style="font-size:12px">
            <el-row>
                ...
                <!-- <el-col>
                    <el-form-item label="计划当前审批人:">
                        <tag-select ref='selectPlanApprove' initDataStr="" placeholder="选择人员" style="width:130px;vertical-align: top;" :initOptions="{selectNum:1,selectType:'User'}" @callBack="(data)=>{selectRoleUser(data,'planApprove')}">
                        </tag-select>
                    </el-form-item>
                </el-col> -->
                <el-col>
    ...
    <div class="content">
        <el-table :data="guideList" border style="width:100%;font-size:12px" height="100%" ref="outsideTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="businessGuideName" label="业务指南名称" align="center" :show-overflow-tooltip="true"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        goReset() {
            ...
            // this.$refs.selectPlanApprove.initDataStrFunc();
        ...
        goDetali(item) {
            ...
            // console.log(item)
            // if (sysEnv !== 1) {
            //     this.$router.push({ name: 'guidePlanDetails', params: { id: item.id } })
            // } else {
            //     let url = '/serviceGuide/index.html#/guidePlanDetails/' + item.id;
            //     EcoUtil.getSysvm().openDialog('业务指南计划详情', url, 850, 700, '12vh');
            // }
        },
