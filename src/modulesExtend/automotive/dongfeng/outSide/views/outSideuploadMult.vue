...
<div class="outSideuploadMult">
    ...
    <div class="second">
        ...
        <eco-file-upload-btn :modular="'outside'" :modularInnerId="modularInnerId" @fileChange="fileChange" style="width:400px;display:inline-block;" @fileOnSuccess="fileOnSuccess" ref="fileUpload"></eco-file-upload-btn>
...
import { outsideExcel, orgExcelImport, uploadMul, downloadExcel, orgExcelImport1, downloadTemplate, downloadResult } from '../api/outside.js'
            ...
            uploadMul(this.excelFile, this.uploadFile, data.parentId).then(res => {
                ...
                if (res == 'ok') {
                    ...
                    setTimeout(function () {
                        ...
                        window.parent.window.sysvm.removeTab('outSideuploadMult');
                    }, 1000)
                }
            })
        },
