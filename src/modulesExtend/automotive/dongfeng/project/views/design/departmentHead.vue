<template>
  <div class="taskList">
    <div class="toolbar">
      <el-button type="primary" @click="Issue" v-show='initRole.PAGE_DC_DEPT_PROFESSION_LEADER.permission.AGREE'>同意</el-button>
      <el-button type="primary" @click="searchArea" v-show='initRole.PAGE_DC_DEPT_PROFESSION_LEADER.permission.SEARCH'>高级查询</el-button>
      <el-button type="primary" @click="getListInfo" v-show='initRole.PAGE_DC_DEPT_PROFESSION_LEADER.permission.SEARCH'>查询</el-button>
      <el-button type="primary" @click="resetForm" v-show='initRole.PAGE_DC_DEPT_PROFESSION_LEADER.permission.SEARCH'>重置</el-button>
    </div>
      ...
      <div class="searchBox">
        ...
        <div class="itemInput">
          <el-select v-model="searchform.status" placeholder="请选择">
            <el-option v-for="(item,key) in designStatusList" :key="key" :label="item" :value="key"></el-option>
          </el-select>
        </div>
    ...
    <eco-content :top="searchHeight" ref="content" bottom="42px" style="padding:0px 15px;">
      <el-table  border stripe height="100%" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" class="styleTableDefaulta">
        ...
        <el-table-column prop="regulatoryCompliance" label="操作" width="60" v-if='initRole.PAGE_DC_DEPT_PROFESSION_LEADER.permission.HANDLE'>
  ...
  data() {
    return {
      ...
      searchform: {
        ...
        phase: "deptProResponsibleApproval",
        projectId: "",
        status: "",
        importantType: "",
        node: "",
