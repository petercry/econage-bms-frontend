<template>
  <div class="taskList">
    <div class="toolbar">
      <el-button type="primary" @click="Issue"  v-show='initRole.PAGE_DC_REGULATION_PROFESSION_LEADER.permission.AGREE'>同意</el-button>
      ...
      <div class="searchBox">
        ...
        <div class="itemInput">
          <el-select v-model="searchform.type" placeholder="请选择">
            <el-option v-for="item in typeList" :key="key" :label="item" :value="key"></el-option>
          </el-select>
        </div> -->
      </div>
    ...
    <eco-content ref="content" :top="searchHeight" bottom="42px" style="padding:0px 15px;">
      <el-table border stripe height="100%" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" class="styleTableDefaulta">
        ...
        <el-table-column prop="regulatoryCompliance" label="操作" width="60"  v-if='initRole.PAGE_DC_REGULATION_PROFESSION_LEADER.permission.HANDLE'>
  ...
  data() {
    return {
      ...
      searchform: {
        ...
        phase: "regulationProResponsibleApproval",
        projectId: "",
        status: "",
        importantType: "",
        node: "",
