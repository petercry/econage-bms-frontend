...
<script>
import { getRegulationList } from '../../api/report'
...
export default {
    ...
    methods: {
        getRegulationList() {
            getRegulationList(this.filterCondition, this.superpositionCondition, this.filterId, this.superpositionId).then(res => {
                console.log(res)
                this.list = res
            })
        },
