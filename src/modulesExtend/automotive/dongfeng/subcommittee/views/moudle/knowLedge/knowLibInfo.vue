    ...
    <div class="knowLibInfo">
        ...
        <eco-content top="0px" height="60px" type="tool" style="border-bottom:1px solid #ddd;">
            <!-- <el-row style="padding:12px 10px;background-color:#fff;">
                <el-col :span="24">
                    <eco-tool-title style="line-height: 34px;margin-right:50px;fontWeight:700;verticalAlign:middle" title="帮助中心"></eco-tool-title>
                    <el-input v-model="keyWords" type="text" style="width:200px;marginLeft:10px;verticalAlign:middle" placeholder="搜索名称"> <i class="el-icon-search el-input__icon" slot="suffix" style="cursor:pointer" @click="handleSearchClick">
                        </i></el-input>
                </el-col>
            </el-row> -->
        </eco-content>
        <eco-content bottom="0" top="61px" ref="content" style="padding:10px 15px;">
            <el-container style="height:100%">
                ...
                <el-main style="padding:0px 10px 0 20px">
                    <knMainTable @callBack="callBack" ref="fileMainTable" :showTool="false" :fullScreen="true"></knMainTable>
                </el-main>
            </el-container>
        </eco-content>
    </div>
