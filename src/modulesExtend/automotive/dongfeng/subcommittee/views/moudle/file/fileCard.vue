...
<div class="fileCard">
    ...
    <eco-content bottom="60px" top="160px" ref="cardContent">
        <fileContent v-if="activeTab=='content'" :fileobj="fileInfo"></fileContent>
        <fileInfo v-if="activeTab=='info'" :entryobj="extInfo" ></fileInfo>
        <fileOpHistory v-if="activeTab=='history'"> </fileOpHistory>
        <filePower v-if="activeTab=='filePower'"  :data="infoObj"> </filePower>
    </eco-content>
    <eco-content bottom="0px" height="60px" style="overflow:hidden;padding:0 6px">
        <div class="file-card-bottom">
            ...
            <el-button @click="showTab('filePower')"><i class="el-icon-view" style="color:#409eff;fontSize:18px;marginRight:3px"></i>权限设置</el-button>
        </div>
    </eco-content>
