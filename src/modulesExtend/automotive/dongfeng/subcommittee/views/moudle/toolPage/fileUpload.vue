    ...
    <div>
        <el-form label-width="120px" class="demo-ruleForm" label-position="left" :model="form" :rules="rules" ref="ruleForm">
            ...
            <el-form-item label="文档编号">
                <el-input v-model="form.fileCode" style="width:400px">
                </el-input>
            </el-form-item>
            ...
            <el-form-item label="文档摘要">
                <el-input v-model="form.summary" style="width:400px" type="textarea">
                </el-input>
            </el-form-item>
            <el-form-item label="备注">
                <el-input v-model="form.comments" style="width:400px" type="textarea">
                </el-input>
            </el-form-item>
