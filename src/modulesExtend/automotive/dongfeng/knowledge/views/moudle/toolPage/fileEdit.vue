    ...
    methods: {
        ...
        getFileData() {
            selectCommon(this.form.id).then(res => {
                ...
                this.handleSelect(res.entity.exposeMembers, exposeArr)
                this.handleSelect(res.entity.hideMembers, hideArr)
                this.handleSelect(res.entity.manageMembers, manageArr)
                ...
                this.data.cooperateLookupMembers = cooperateLookupStr
                this.data.cooperateDownloadMembers = cooperateDownloadStr
