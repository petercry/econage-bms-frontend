    ...
    <div>
        <el-form label-width="70px" class="demo-ruleForm" label-position="left" :model="form" :rules="rules" ref="ruleForm">
            ...
            <el-form-item label="查看用户">
                <tag-select style="width: 300px;vertical-align: top;" :initDataStr="exposeMembers" ref="tagSelect" :initOptions="{selectNum: 2,selectType: 'Dept-User-Role-userGroup'}" @callBack="exposeMember">
                </tag-select>
            </el-form-item>
            <el-form-item label="隐藏用户">
                <tag-select style="width: 300px;vertical-align: top;" :initDataStr="hideMembers" ref="tagSelect" :initOptions="{selectNum: 2,selectType: 'Dept-User-Role-userGroup'}" @callBack="hideMember">
                </tag-select>
            </el-form-item>
            <el-form-item label="管理用户">
                <tag-select style="width: 300px;vertical-align: top;" :initDataStr="manageMembers" ref="tagSelect" :initOptions="{selectNum: 2,selectType: 'Dept-User-Role-userGroup'}" @callBack="manageMember">
                </tag-select>
            </el-form-item>
        </el-form>
        <el-col align="center">
...
<script>
import { createFolder } from '../../../api/knowledge.js'
