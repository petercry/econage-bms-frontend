...
<script>
import { newAddCommon, editCommon, getstdCategory, getstdSubCategory } from '../../../api/fileCard.js'
    ...
    watch: {
        data(nv, ov) {
            if (nv != '') {
                ...
                // console.log(nv.data.stdCategory)
                getstdSubCategory(nv.data.stdCategory).then(res => {
                    console.log(res)
                    this.stdSubCategoryList = res
                })
            }
