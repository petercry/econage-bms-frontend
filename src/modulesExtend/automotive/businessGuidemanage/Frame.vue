...
<script>
  ...
  export default {
      ...
      created(){
          ...
          this.setsupportStatus();
          this.setSupportReview();
          this.setStateFlow();
          this.setPhaseStatus();
          this.setUsageList();
          this.setRequirementCompare();
          this.setStatePlanFlow();
          this.setPlanPhaseStatus();
        //   this.getUserInfo();
      },
      methods: {
          ...mapActions(['setPlanPhaseStatus','setRequirementCompare','setEditType','setOperationType','setsupportStatus','setStateFlow','setSupportReview','setPhaseStatus','setUsageList','setStatePlanFlow']),
          /*初始化主题*/
          initTheme(){
