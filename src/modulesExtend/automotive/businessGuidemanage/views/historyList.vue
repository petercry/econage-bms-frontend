...
<script>
    ...
    import {programApproveHistory} from '../service/service.js'
    export default {
        name:'historyList',
        data(){
            return {
        ...
        mounted(){
            this.flowSrc = '/modelflowView/index.html#/index/guidelineFlowGraph/'+this.id;
            this.requestData();
        },
        methods:{
            requestData(){
               ...
               programApproveHistory(params).then(res=>{
