    ...
    <div class="layoutInnerAbsoluteDiv">
      <eco-content top="0px" height="55px" type="tool" style="border-bottom:1px solid #ddd;background-color:#fff;">
        <el-row style="padding:12px 20px;background-color:#fff;">
          <el-col :span="12">
            <eco-tool-title style="font-weight: 700;line-height: 30px;" :title="'标准规划查询'"></eco-tool-title>
          </el-col>
        </el-row>
      </eco-content>
      <eco-content top="70px" bottom="0px" type="tool" style="background-color:#fff;">
        <div class="standard" v-loading="loading">
              ...
              <el-row>
                <el-col :span="6">
                  <el-form-item label="年度">
                    <el-input v-model="form.year" style="width:100%"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
          ...
          <div class="table" style="display:flex;">
            <el-tree :data="treeData" :props="defaultProps" style="width:180px"></el-tree>
            <el-table :data="tableData" style="width: 100%" height="100%" stripe :header-cell-style="{background:'##f5f7fa'}" @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="programName" label="标准名称">
              </el-table-column>
              ...
              <el-table-column prop="address" label="当前审批人">
              </el-table-column>
  ...
  methods: {
    ...
    deit(val) {
      if (sysEnv !== 1) {
        ...
        let _url = "/standardPlanning/index.html#/editDetail/" + val.id;
    ...
    detaliDpet() {
      ...
      if (this.selcetrows.length == 0) {
        ...
        return
          ...
          if (sysEnv !== 1) {
            this.$router.push({name: "detaliDpet",params: { ids: list.toString() },});
          } else {
            let _url = "/standardPlanning/index.html#/detaliDpet/" + list.toString();
