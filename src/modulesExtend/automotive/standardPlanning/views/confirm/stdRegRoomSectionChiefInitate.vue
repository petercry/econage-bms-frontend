  ...
  data() {
    return {
      ...
      form: {
        ...
        sourceNumber: "",
        systemCode: "",
        phaseId: "STD_REGULATIONS_ROOM_SECTION_CHIEF_INITIATE",
        page: 1,
        rows: 10,
      },
      total: 0,
  ...
  methods: {
    ...
    deit(val) {
      if (sysEnv !== 1) {
        this.$router.push({
          name: "conditionEdit",
          params: { id: val.id, name: 'STD_REGULATIONS_ROOM_SECTION_CHIEF_INITIATE' },
        });
      } else {
        let _url = "/standardPlanning/index.html#/conditionEdit/" + val.id + '/' + 'STD_REGULATIONS_ROOM_SECTION_CHIEF_INITIATE';
