<template>
  <div class="standardReview" v-loading="loading">
    <div class="clearfix">
      <div class="btn">
    ...
    listAction() {
      let callBackDialogFunc = function (obj) {
        if (
          ...
          window.standardReviewvm.getList();
        }
      };
      EcoUtil.addCallBackDialogFunc(callBackDialogFunc, "standardReviewvm");
    },
  },
};
</script>
...
.standardReview .search {
  background-color: #f5f5f5;
  height: 160px;
  padding-top: 10px;
  padding-right: 10px;
}
.standardReview .table {
  padding: 20px 20px 0 20px;
}
</style>
<style>
.standardReview .el-button--primary.is-plain {
  background-color: white;
}
.standardReview .export {
  color: #409eff;
  border: 1px solid #409eff;
}
.standardReview .el-form-item--mini.el-form-item,
.el-form-item--small.el-form-item {
  margin-bottom: 10px;
}
.standardReview .export:focus {
  outline: none;
  box-shadow: none;
  background-color: transparent;
}
.standardReview .el-pagination {
  float: right;
