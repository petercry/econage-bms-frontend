<template>
  <div class="secondConfirmation" v-loading="loading">
    <div class="clearfix">
      <div class="btn">
    ...
    <!-- 全展开搜索区域 -->
    <div class="search" :style="{ 'height': all == 'open' ? '160px' : '40px'}" v-show="show">
      <el-form ref="form" :model="form" label-width="110px" label-position="center">
        <el-row>
          ...
          <el-col :span="4" v-show="all == 'shrink'">
    ...
    <!-- 表格 -->
    <div class="table">
      <el-table :data="tableData" style="width: 100%" stripe :header-cell-style="{background:'##f5f7fa'}" @selection-change="handleSelectionChange">
...
export default {
  ...
  created() {
    ...
    this.getList();
    this.listAction();
    window.secondConfirmationvm = this;
  },
  methods: {
    // 获取基础数据
    getBaseInfo() {
    ...
    listAction() {
      let callBackDialogFunc = function (obj) {
        if (
          ...
          window.secondConfirmationvm.getList();
        }
      };
      EcoUtil.addCallBackDialogFunc(callBackDialogFunc, "secondConfirmationvm");
    },
  },
};
</script>
<style scoped>
.secondConfirmation .btn {
  float: right;
  margin-right: 20px;
  margin-bottom: 20px;
}
.secondConfirmation .search {
  background-color: #f5f5f5;
  height: 160px;
  padding-top: 10px;
  padding-right: 10px;
}
.secondConfirmation .table {
  padding: 20px 20px 0 20px;
}
</style>
<style>
.secondConfirmation .el-button--primary.is-plain {
  background-color: white;
}
.secondConfirmation .export {
  color: #409eff;
  border: 1px solid #409eff;
}
.secondConfirmation .el-form-item--mini.el-form-item,
.el-form-item--small.el-form-item {
  margin-bottom: 10px;
}
.secondConfirmation .export:focus {
  outline: none;
  box-shadow: none;
  background-color: transparent;
}
.secondConfirmation .el-pagination {
  float: right;
