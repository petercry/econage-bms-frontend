<template>
  <div class="ministerReview" v-loading="loading">
    <div class="clearfix">
      <div class="btn">
  ...
  data() {
    return {
      ...
      form: {
        ...
        sourceNumber: "",
        systemCode: "",
        phaseId: "SPECIFIC_DEPT_MINISTER_VERIFY",
        page: 1,
        rows: 10,
      },
      total: 0,
    ...
    listAction() {
      let callBackDialogFunc = function (obj) {
        if (
          ...
          window.ministerReviewvm.getList();
        }
      };
      EcoUtil.addCallBackDialogFunc(callBackDialogFunc, "ministerReviewvm");
    },
  },
};
</script>
...
.ministerReview .search {
  background-color: #f5f5f5;
  height: 160px;
  padding-top: 10px;
  padding-right: 10px;
}
.ministerReview .table {
  padding: 20px 20px 0 20px;
}
</style>
<style>
.ministerReview .el-button--primary.is-plain {
  background-color: white;
}
.ministerReview .export {
  color: #409eff;
  border: 1px solid #409eff;
}
.ministerReview .el-form-item--mini.el-form-item,
.el-form-item--small.el-form-item {
  margin-bottom: 10px;
}
.ministerReview .export:focus {
  outline: none;
  box-shadow: none;
  background-color: transparent;
}
.ministerReview .el-pagination {
  float: right;
