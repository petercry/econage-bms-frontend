<template>
  <div class="committeeReview" v-loading="loading">
    <div class="clearfix">
      <div class="btn">
    ...
    listAction() {
      let callBackDialogFunc = function (obj) {
        if (
          ...
          window.committeeReviewvm.getList();
        }
      };
      EcoUtil.addCallBackDialogFunc(callBackDialogFunc, "committeeReviewvm");
    },
  },
};
</script>
...
.committeeReview .search {
  background-color: #f5f5f5;
  height: 160px;
  padding-top: 10px;
  padding-right: 10px;
}
.committeeReview .table {
  padding: 20px 20px 0 20px;
}
</style>
<style>
.committeeReview .el-button--primary.is-plain {
  background-color: white;
}
.committeeReview .export {
  color: #409eff;
  border: 1px solid #409eff;
}
.committeeReview .el-form-item--mini.el-form-item,
.el-form-item--small.el-form-item {
  margin-bottom: 10px;
}
.committeeReview .export:focus {
  outline: none;
  box-shadow: none;
  background-color: transparent;
}
.committeeReview .el-pagination {
  float: right;
