<template>
  <div class="deptLiaisonReview" v-loading="loading">
    <div class="clearfix">
      <div class="btn">
...
export default {
  ...
  created() {
    ...
    this.getList();
    this.listAction();
    window.deptLiaisonReviewvm = this;
  },
  methods: {
    // 获取基础数据
    getBaseInfo() {
    ...
    listAction() {
      let callBackDialogFunc = function (obj) {
        if (
          ...
          window.deptLiaisonReviewvm.getList();
        }
      };
      EcoUtil.addCallBackDialogFunc(callBackDialogFunc, "deptLiaisonReviewvm");
    },
  },
};
</script>
<style scoped>
.deptLiaisonReview .btn {
  float: right;
  margin-right: 20px;
  margin-bottom: 20px;
}
.deptLiaisonReview .search {
  background-color: #f5f5f5;
  height: 160px;
  padding-top: 10px;
  padding-right: 10px;
}
.deptLiaisonReview .table {
  padding: 20px 20px 0 20px;
}
</style>
<style>
.deptLiaisonReview .el-button--primary.is-plain {
  background-color: white;
}
.deptLiaisonReview .export {
  color: #409eff;
  border: 1px solid #409eff;
}
.deptLiaisonReview .el-form-item--mini.el-form-item,
.el-form-item--small.el-form-item {
  margin-bottom: 10px;
}
.deptLiaisonReview .export:focus {
  outline: none;
  box-shadow: none;
  background-color: transparent;
}
.deptLiaisonReview .el-pagination {
  float: right;
