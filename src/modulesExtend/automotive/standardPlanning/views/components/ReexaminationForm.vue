  ...
  <div class="ReexaminationForm">
    <el-form :model="form" label-width="120px">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="使用情况">
            <el-select v-model="form.usage" placeholder="请选择" style="width:100%">
      ...
      <el-form-item label="复审结论">
        ...
        <div class="box">
          <div v-show="form.reviewConclusion == 'ENABLE'">
            ...
            <el-input style=" margin-top: 10px;" type="textarea" :rows="6" placeholder="请输入内容" v-model="form.standardSituation">
            </el-input>
          </div>
          <div v-show="form.reviewConclusion == 'OBSOLETED'">
            <span style="color:#606265">废止理由说明</span>
            <el-input style=" margin-top: 10px;" type="textarea" :rows="6" placeholder="请输入内容" v-model="form.revocationReason">
            </el-input>
          </div>
          <div v-show="form.reviewConclusion == 'MODIFY'">
            <el-row>
              <el-col :span="12">
                <el-form-item label="修订方案及名称">
                  <el-input v-model="form.revisedProject"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="修订人">
                  <tag-select style="width:100%" :initDataStr="userInitDataStr" :initOptions="{selectNum:1,selectType:'User'}" @callBack="(val)=>selectRoleUser(val)">
                  </tag-select>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-form-item label="内容简介">
              <el-input style=" margin-top: 10px;" type="textarea" :rows="4" placeholder="请输入内容" v-model="form.introduction">
              </el-input>
            </el-form-item>
          </div>
        </div>
      ...
      <el-form-item label="备注">
        <el-input style=" margin-top: 10px;" type="textarea" :rows="3" placeholder="请输入内容" v-model="form.remarks">
        </el-input>
      </el-form-item>
    </el-form>
    <div class="btn">
