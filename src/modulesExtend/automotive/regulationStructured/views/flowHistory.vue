                    ...
                    <el-row>
                        ...
                        <el-col :span='12'>
                            <el-form-item label='代替法规:' prop='substituteCode'>
                                <span class="viewContent">{{formData.substituteCode}}</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span='23'>
                            <el-form-item label='法规引用:' prop='regulatoryReferences'>
                                <span class="viewContent" >{{formData.regulatoryReferences||'暂无填写'}}</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span='23'>
                            <el-form-item label='标准文档:'>
                                <upload :isEdit='false' ref='upload1' :showList='true' :multiple="false" :modular="modular" :modularInnerId="structurebaseModularInnerId"
                    ...
                    <el-row>
                        <el-col :span='23'>
                            <el-form-item label='相关文件:'>
                                <upload :isEdit='false'  ref='upload2'  :showList='true' :multiple="false" :modular="modular2" :modularInnerId="structurebaseModularInnerId"
                    ...
                    <el-row>
                        <el-col :span='23'>
                            <el-form-item label='关联产品技术路线:' prop='technicalRoute'>
                                <span class="viewContent">{{formData.technicalRoute||'暂无填写'}}</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span='23'>
                            <el-form-item label='技术路线:'>
                                <upload :isEdit='false'  :showList='true' :multiple="false" :modular="modular3" :modularInnerId="structurebaseModularInnerId"
                                    @preView='preView' @fileChange="fileChange"  accept=''>
                                    <el-button slot="uploadBtn" size="medium" class="uploadBtn">
                                        <i class="el-icon-plus"></i> 上传附件</el-button>
                                </upload>
                    ...
                    <el-row>
                        <el-col :span='12'>
                            <el-form-item label='跟踪方式:' prop='trackMethod'>
                                <span  class="viewContent">{{formData.trackMethod||'暂无填写'}}</span>
                            </el-form-item>
                        </el-col>
                        <el-col :span='12'>
                            <el-form-item label='跟踪频率:' prop='trackFrequency'>
                                <span  class="viewContent">{{formData.trackFrequency||'暂无填写'}}</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
...
<script>
    ...
    import {structurebaseArchiveDetails,structurebaseApproveList,getUserInfoByOrgId} from '../service/service.js'
    export default {
        name:'flowHistory',
        data(){
            return {
        ...
        methods:{
            ...
            getDetails(){
                this.loading = true;
                structurebaseArchiveDetails(this.id).then(res=>{
            ...
            requestData(isFirstPage){
             ...
             structurebaseApproveList(this.id).then(res=>{
