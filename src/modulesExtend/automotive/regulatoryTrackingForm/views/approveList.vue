    ...
    <eco-content top='0px' bottom='0px' type='tool' style='background-color:#F5F5F5;'>
        <div class='approveList'>
            ...
            <eco-content top='0px' height='60px' type='tool'>
                <el-row style='padding: 14px;background:#fff;border: 1px solid #ddd;'>
                    ...
                    <el-col :span='19' style='text-align:right;margin-top:2px;'>
                        ...
                        <el-button type='primary' size='small' @click='appropeCase' v-show='btnRoleObj["dongfeng.thinktank.regulationtrack.approve_agree"]'>同意</el-button>
                        <el-button type='primary' size='small' @click='withdrawCase' v-show='btnRoleObj["dongfeng.thinktank.regulationtrack.approve_reject"]'>驳回</el-button>
                    </el-col>
                </el-row>
            </eco-content>
            <eco-content v-show='isShowSearch' top='59px' height='160px' type='tool' style='border:1px solid #ddd;overflow: hidden;'>
                <el-row style="padding:15px 10px 16px 10px;background:#fff">
                    <el-col>
                        ...
                        <span class='searchInputLabel'>&emsp;&emsp;办理状态:</span>
            ...
            <eco-content :top='contentTop' bottom='42px' style='padding:10px 15px;border:1px solid #ddd;'>
                <el-table ref='approveListTable' @selection-change="handleSelectionChange"  stripe :data='tableData'
                    ...
                    <el-table-column label='到达时间' prop='publishUserAssignTime' width='150'></el-table-column>
...
<script>
    ...
    import { regulationtrackWithdraw,approvalList, regulationtrackApprove,getRoleBtnSetting } from '../service/service.js'
    export default {
        name: 'approveList',
        components: {
            ecoContent,
        ...
        methods: {
            ...
            doAppropeCase(content){
                ...
                this.multipleSelection.forEach(item=>{
                    regulationtrackApprove(item.id,content).then(res => {
                        if(this.timer){
            ...
            appropeCase() {
                ...
                //     return EcoMessageBox.alert('同意操作不能批量处理,请选中一条数据', '提示');
                // }
                var url = '/regulatoryTrackingForm/index.html#/withdrawPage/' + true;
            ...
            withdrawCase() {
                ...
                // }
                var url = '/regulatoryTrackingForm/index.html#/withdrawPage/' + false;
            ...
            callAction() {
                ...
                EcoUtil.addCallBackDialogFunc(callBackDialogFunc, 'approveList');
            },
            editCase(row) {
                let _width = '1000';
                let _height = '500';
                let url = '/regulatoryTrackingForm/index.html#/editPage/' + row.id + '/viewCase/approveList';
                let dialogTitle = '查看';
...
<style scoped>
    ...
    .approveList .plainBtn:first-of-type {
        margin-left: 20px;
    }

    .approveList .searchInputLabel {
        font-size: 14px;
        margin-left: 8px;
    }
