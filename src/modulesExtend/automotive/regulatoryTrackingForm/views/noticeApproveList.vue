        ...
        <div class='noticeApproveList'>
            ...
            <eco-content top='0px' height='60px' type='tool'>
                <el-row style='padding: 14px;background:#fff;border: 1px solid #ddd;'>
                    ...
                    <el-col :span='19' style='text-align:right;margin-top:2px;'>
                        ...
                        <el-button type='primary' size='small' @click='openOption(true)' v-show='btnRoleObj["regulation-notification.approving_agree"]'>同意</el-button>
                        <el-button type='primary' size='small' @click='openOption(false)' v-show='btnRoleObj["regulation-notification.approving_reject"]'>驳回</el-button>
                    </el-col>
                </el-row>
            </eco-content>
            ...
            <eco-content :top='contentTop' bottom='42px' style='padding:10px 15px;border:1px solid #ddd;'>
                <el-table ref='noticeListTable' @selection-change="handleSelectionChange"  @current-change="handleRowClickChange" highlight-current-row stripe :data='tableData' header-row-class-name='tableHeader'
                    ...
                    <el-table-column label='发起人' prop='approvingAssigneeName'></el-table-column>
                    <el-table-column label='到达时间' prop='approveAssignTime' width='140'></el-table-column>
...
<script>
    ...
    import { getRoleBtnSetting,regulationNotificationApproving,regulationtrackFlowApprove } from '../service/service.js'
    export default {
        ...
        methods: {
            ...
            callAction() {
                ...
                EcoUtil.addCallBackDialogFunc(callBackDialogFunc, 'noticeApproveList');
            },
            ...
            requestData(type,isFirstPage) {
                ...
                regulationNotificationApproving(params).then(res => {
...
<style scoped>
    ...
    .noticeApproveList .plainBtn:first-of-type {
        margin-left: 20px;
    }

    .noticeApproveList .searchInputLabel {
        font-size: 14px;
        margin-left: 8px;
    }
