...
//状态字典表
export const ridehailingStatus = function () {
  return axios.get(baseUrl + '/dongfeng/ridehailing/status-enum', {
    params: {
      time: new Date().getTime()
    }
  })
...
//操作类型
export const  ridehailingOperate= function () {
  return axios.get(baseUrl + '/dongfeng/ridehailing/operate-enum', {
    params: {
      time: new Date().getTime()
    }
  })
...
//查询列表
export const ridehailingList = function (data) {
  return axios.get(baseUrl + '/dongfeng/ridehailing/pagination', {
    params: {
      time: new Date().getTime(),
      ...data
    },
...
//编制新增
export const  ridehailingAdd= function (data) {
  return axios.post(baseUrl + '/dongfeng/ridehailing/add-single?time=' + new Date().getTime(), JSON.stringify(data),
    {
      headers: { 'Content-Type': 'application/json;charset=UTF-8' },
      traditional: true
    })
...
//查询详情
export const   ridehailingDeatils = function (id) {
  return axios.get(baseUrl + '/dongfeng/ridehailing/select-by-id?id='+id, {
    params: {
      time: new Date().getTime(),
    }
  })
...
// 编制更新
export const  ridehailingUpdate= function (data) {
  return axios.put(baseUrl + '/dongfeng/ridehailing/update-single', {
    ...data,
    time: new Date().getTime()
  }, {
      headers: { 'Content-Type': 'application/json;charset=UTF-8' },
...
//申请修改
export const  ridehailingApplyUpdate= function (data) {
  return axios.post(baseUrl + '/dongfeng/ridehailing/copy4update-single', {
    ...data,
    time: new Date().getTime()
  }, {
      headers: { 'Content-Type': 'application/json;charset=UTF-8' },
...
//提交
export const  ridehailingSubmit= function (id,assigneeId) {
  return axios.put(baseUrl + '/dongfeng/ridehailing/submit-single?id='+id+'&assigneeId='+assigneeId, {
    time: new Date().getTime()
  },{
      traditional: true
    })
...
//删除
export const ridehailingDel = function (id) {
  return axios.delete(baseUrl + '/dongfeng/ridehailing/delete-by-id', {
    params: {
      time: new Date().getTime(),
      id
    }
...
//申请删除
export const ridehailingApplyDel = function (id){
  return axios.post(baseUrl + '/dongfeng/ridehailing/copy4Delete-single?id='+id,{
    time: new Date().getTime()
  },{
    traditional: true
  })
...
//同意
export const  ridehailingApprove= function (id) {
  return axios.put(baseUrl + '/dongfeng/ridehailing/audit-single?opinion=true&id=' + id, {
    time: new Date().getTime()
  }, {
      traditional: true
    })
...
//退回
export const ridehailingWithdraw = function (data) {
  return axios.put(baseUrl + '/dongfeng/ridehailing/audit-single?id='+data.id+'&opinion=false', {
    time: new Date().getTime()
  }, {
      traditional: true
    })
...
//导出
export const  ridehailingExport = function(data){
  return axios.get(baseUrl+'/dongfeng/ridehailing/excel-export-download',{
        params:{
            ...data,
            time: new Date().getTime(),
        },
...
//导入
export const ridehailingImport = function (data) {
  return axios.post(baseUrl + '/dongfeng/ridehailing/excel-import',data,
    {
