...
//证书列表
export const certificateList=function(data){
  return axios.get(baseUrl+'/dongfeng/certificate/pagination',{
    params:{
      time:new Date().getTime(),
      ...data
    },
...
//证书管理 查看单个
export const certificateSingle=function(id){
  return axios.get(baseUrl+'/dongfeng/certificate/select-by-id',{
    params:{
      time:new Date().getTime(),
      id
    }
...
//证书管理 更新单个
export const  certificateUpdate= function(data){
  return axios.put(baseUrl+'/dongfeng/certificate/update-single',{
    ...data,
    time:new Date().getTime()
  },{
    headers: {'Content-Type': 'application/json;charset=UTF-8'},
...
//证书管理 新建单个
export const  certificateAdd= function(data){
  return axios.post(baseUrl+'/dongfeng/certificate/add-single',{
    time:new Date().getTime(),
    ...data
  },{
    headers: {'Content-Type':'application/json;charset=UTF-8'},
...
//证书管理 通过id删除
export const  certificateDel= function(id){
  return axios.delete(baseUrl+'/dongfeng/certificate/delete-by-id?id='+id,{
     params:{
        time:new Date().getTime()
     }
  },{
...
///dongfeng/certificate/excel-export-download
...
export const  certificateExport = function(data){
  return axios.get(baseUrl+'/dongfeng/certificate/excel-export-download',{
        params:{
            ...data,
            time: new Date().getTime(),
        },
