<template>
  <div class="handleTextareaVue designItem" v-show="isVisible">
             ...
             if(this.isEditable ){
                if(this.isRequired ){
                    if(!this.value || this.value == ''){
                        return { status:1,msg:this.mItem.itemName+' 必须填写',checkType:'TEXTAREA',checkId:'handleItem-'+this.mItem.viewId+'-'+this.mItem.itemId,itemId:this.mItem.itemId} ;
                    }
                }
            }
            return {status:0}
