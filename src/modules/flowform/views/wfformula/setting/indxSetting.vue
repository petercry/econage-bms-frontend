<template>
    <div class="indxParams" v-show="paramsObj.loaded1 && paramsObj.loaded2">
            <div class="itemVueName">INDX 参数设置</div>
            <div class="setting">
...
export default{
    ...
    methods: {
        ...
        init(){
            ...
            this.$set(this.paramsObj,'paramsArray',(_paramsObj && _paramsObj.paramsArray)? _paramsObj.paramsArray:[{name:null,value:null,type:2},{name:null,value:null,type:1}]);
...
.indxParams .ecoSettingBlock{
    margin-bottom:10px;
}

.indxParams .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.indxParams .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
