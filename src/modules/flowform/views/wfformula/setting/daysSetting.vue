<template>
    ...
    <div class="daysParams" v-show="paramsObj.loaded1 && paramsObj.loaded2">
            <div class="itemVueName">DAYS 参数设置</div>
            <div class="setting">
...
.daysParams .ecoSettingBlock{
    margin-bottom:10px;
}

.daysParams .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.daysParams .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
