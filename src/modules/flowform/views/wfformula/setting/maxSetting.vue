<template>
    ...
    <div class="maxParams" v-show="paramsObj.loaded1 && paramsObj.loaded2">
            <div class="itemVueName">MAX 参数设置</div>
            <div class="setting">
...
.maxParams .ecoSettingBlock{
    margin-bottom:10px;
}

.maxParams .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
