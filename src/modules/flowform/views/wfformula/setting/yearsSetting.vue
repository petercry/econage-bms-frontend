<template>
    ...
    <div class="yearsParams" v-show="paramsObj.loaded1 && paramsObj.loaded2">
            <div class="itemVueName">YEARS 参数设置</div>
            <div class="setting">
...
.yearsParams .ecoSettingBlock{
    margin-bottom:10px;
}

.yearsParams .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.yearsParams .ecoSettingDesc .del{
    font-size: 12px;
    color: #f56c6c;
    height: 32px;
    line-height: 32px;
...
.yearsParams .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.yearsParams .funcItem:hover{
    background-color:rgb(233,250,255);
}

.yearsParams .plainBtn{
    border-color: #409eff;
    color: #409eff;
    font-size: 14px;
    margin-right:10px;
