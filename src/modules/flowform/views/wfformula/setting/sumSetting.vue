<template>
    ...
    <div class="sumParams" v-show="paramsObj.loaded1 && paramsObj.loaded2">
            <div class="itemVueName">SUM 参数设置</div>
            <div class="setting">
...
.sumParams .ecoSettingBlock{
    margin-bottom:10px;
}

.sumParams .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
