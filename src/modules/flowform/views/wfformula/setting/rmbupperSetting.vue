<template>
    ...
    <div class="rmbupperParams" v-show="paramsObj.loaded1 && paramsObj.loaded2">
            <div class="itemVueName">RMBUPPER 参数设置</div>
            <div class="setting">
            <div class="ecoSettingBlock" v-for="(paramItem,idx) in paramsObj.paramsArray" :key="idx">

                <el-row class="ecoSettingDesc">
                        <el-col :span="20" class="title"><span>{{'参数'}}</span> </el-col>
...
.rmbupperParams .setting{
    margin:10px 10px 50px 20px;
}

.rmbupperParams .itemVueName{
    Font-weight: bold;
...
.rmbupperParams .ecoSettingBlock{
    margin-bottom:10px;
}

.rmbupperParams .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.rmbupperParams .ecoSettingDesc .del{
    font-size: 12px;
    color: #f56c6c;
    height: 32px;
    line-height: 32px;
...
.rmbupperParams .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.rmbupperParams .funcItem:hover{
    background-color:rgb(233,250,255);
}

.rmbupperParams .plainBtn{
    border-color: #409eff;
    color: #409eff;
    font-size: 14px;
    margin-right:10px;
