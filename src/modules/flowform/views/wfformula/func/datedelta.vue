<template>
    <span class="datedeltaFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >

        <span class="desc1" @click="clickParams">DATEDELTA</span>
...
export default{
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaDatedeltaSetting';
...
.datedeltaFunc .needSetDesc i{
    background-color: none;
}

.datedeltaFunc .hasSetDesc{
    font-size: 14px;
    padding-left:5px;
    padding-right:5px;
    color:#999;
