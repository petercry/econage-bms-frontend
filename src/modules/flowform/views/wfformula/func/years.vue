<template>
    <span class="yearsFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >

        <span class="desc1" @click="clickParams">YEARS</span>
...
export default{
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaYearsSetting';
...
.yearsFunc .needSetDesc i{
    background-color: none;
}

.yearsFunc .hasSetDesc{
    font-size: 14px;
    padding-left:5px;
    padding-right:5px;
    color:#999;
