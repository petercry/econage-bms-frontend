<template>
    <span class="rmbupperFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >

        <span class="desc1" @click="clickParams">RMBUPPER</span>
...
export default{
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaRmbupperSetting';
...
.rmbupperFunc .needSetDesc i{
    background-color: none;
}

.rmbupperFunc .hasSetDesc{
    font-size: 14px;
    padding-left:5px;
    padding-right:5px;
    color:#999;
