<template>
    <span class="minFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >

        <span class="desc1" @click="clickParams">MIN</span>
...
export default{
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaMinSetting';
