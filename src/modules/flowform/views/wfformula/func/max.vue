<template>
    <span class="maxFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >

        <span class="desc1" @click="clickParams">MAX</span>
...
export default{
    ...
    computed:{
        ...
        paramsObj(){
            ...
            let _item = {};
            _item.paramsArray = _params?_params.paramsArray:[{name:null,value:null,type:1,uuid:null}];
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaMaxSetting';
