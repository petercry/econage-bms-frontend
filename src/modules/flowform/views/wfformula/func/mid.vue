<template>
    <span class="midFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >

        <span class="desc1" @click="clickParams">MID</span>
...
export default{
    ...
    computed:{
        ...
        paramsObj(){
            ...
            let _item = {};
            _item.paramsArray = _params?_params.paramsArray:[{name:null,value:null,type:1,uuid:null},{name:null,value:null,type:1,uuid:null},{name:null,value:null,type:1,uuid:null}];
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaMidSetting';
