<template>
    <span class="tonumberFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >
        <span class="desc1" @click="clickParams">TONUMBER</span>
...
export default{
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaTonumberSetting';
...
.tonumberFunc .needSetDesc i{
    background-color: none;
}

.tonumberFunc .hasSetDesc{
    font-size: 14px;
    padding-left:5px;
    padding-right:5px;
    color:#999;
