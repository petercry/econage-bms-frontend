<template>
    ...
    <span class="calculateFunc formulaFuncItem" v-bind:class="{'clickActive':isClickActive}"  >
        <span class="desc1" @click="clickParams">CALCULATE</span>
...
export default{
    ...
    methods: {
        ...
        clickParams(){
            ...
            _data.paramsName = 'formulaCalculateSetting';
...
.calculateFunc .needSetDesc i{
    background-color: none;
}

.calculateFunc .hasSetDesc{
    font-size: 14px;
    padding-left:5px;
    padding-right:5px;
    color:#999;
