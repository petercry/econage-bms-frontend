<template>
<div class="designInput designItem ">
      <ecoField :titleWidth="itemObj.titleWidth" :bgColor="itemObj.bgColor" :titlePos="itemObj.titlePos" :textAlign="itemObj.titleAlign"
        class="designField" :required="itemObj.nullable == 0" :verticalAlign="itemObj.verticalAlign">
        ...
        <div slot="content" style="text-align:center;"> 
            <el-button type="primary" size="mini">{{itemObj.fileUploadbutton}}</el-button>
...
export default{
  ...
  computed:{
        itemObj(){
            ...
            _item.fileUploadbutton = this.mConfig?this.mConfig.fileUploadbutton:this.mItem.fileUploadbutton;
