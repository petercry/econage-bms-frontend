<template>
    <div class="designSelectSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
        <div class="itemVueName">下拉选框</div>
        <div class="setting">
            ...
            <div class="ecoSettingBlock">
             ...
             <div class="ecoSettingBlock">
                <div class="ecoSettingDesc"><span class="title">组件显示宽度( % )</span></div>
                <div>
                    <el-slider v-model="config.itemWidth"  :min="10" :max="100" :step="1" show-input input-size="mini" ></el-slider>
                </div>
            </div>
 ...
 computed:{
  ...
  methods: {
       ...
       initConfig(_itemOperateId,_itemId,remap){
            ...
            _config.itemWidth = remap?remap.item_model.itemWidth:100;
