            ...
            <div class="ecoSettingBlock">
                <el-row class="ecoSettingDesc">
                    <el-col :span="24" class="title">
                         <el-button  @click="goSealSelect" class="plainBtn" size="medium" style="width:100%;">点击选择印章 {{config.defaultSeal?'(1)':''}}</el-button>
                    </el-col>
                </el-row>
            </div>
  ...
  methods: {
       ...
       goSealSelect(){
           ...
           // this.config.defaultSeal = '1171390088302280704';
            let _url = '/flowform/index.html#/signatureSetting/'+this.config.itemOperateId;
            EcoUtil.getSysvm().openDialog('印章设置',_url,'650','400','8hv');
       },
