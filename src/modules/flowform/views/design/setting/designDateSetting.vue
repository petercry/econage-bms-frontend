            ...
            <div class="ecoSettingBlock">
                    ...
                    <div>
                        <el-radio-group v-model="config.defaultId" style="margin-bottom: 15px;" @change="changeDefaultId">
                            <el-radio-button :label="item.id" v-for="item in dateDefaultIdArray" :key="item.id">{{item.text}}</el-radio-button>
                        </el-radio-group>
                        ...
                        <div v-show="config.defaultId == '7'"></div>
                    </div>
            </div>
  ...
  methods: {
       ...
       listAction(){
            let callBackDialogFunc = function(obj){
                if(obj && obj.action == 'formulaSettingV2Callback'){
