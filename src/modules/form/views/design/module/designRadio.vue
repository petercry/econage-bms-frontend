...
<div class="designSelect designItem">
      <ecoField :titleWidth="itemObj.titleWidth"  :bgColor="itemObj.bgColor" :titlePos="itemObj.titlePos" :required="itemObj.required" :textAlign="itemObj.titleAlign" class="designField">
            ...
            <div slot="content"> 
                    <el-radio-group :value="itemObj.sysOptionsDefautl" size="mini" style="width:100%">
                        <el-radio v-bind:style="itemObj.checkStyleObject" style="margin-top:2px;margin-bottom:2px;" 
