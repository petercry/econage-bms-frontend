<template>
    <div class="designImgSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
        <div class="itemVueName">图片</div>
        <div class="setting">
 ...
 computed:{
  ...
  methods: {
       ...
       initConfig(_fieldId,remap){
            ...
            _config.view.display =  remap?remap.view.display:'图片';
            ...
            _config.model.display = remap?remap.model.display:'图片',
...
<style scoped>
.designImgSettingVue .setting{
    margin:10px 20px 50px 20px;
}

.designImgSettingVue .itemVueName{
    Font-weight: bold;
...
.designImgSettingVue .optionsDiv{
    font-size: 13px;
    line-height: 30px;
    height:30px;
...
.designImgSettingVue .optionsDiv .iconfont{
    vertical-align: middle;
}

.designImgSettingVue .optionsDiv .meixuanzhong{
    color:rgba(0, 0, 0, 0.65);
}

.designImgSettingVue .optionsDiv .xuanzhong{
    color:#409eff;
}

.designImgSettingVue .optionsDiv .handle{
    color:#409eff;
    cursor: move;
    font-size: 16px;
}
.designImgSettingVue .optionsDiv .deleteicon{
    color:#409eff;
    cursor: pointer;
    font-size: 16px;
}
.designImgSettingVue .optionsDiv input{
    vertical-align: middle;
    border:0px;
    outline:none;
    color:rgba(0, 0, 0, 0.65);
...
.designImgSettingVue  .addOptions{
...
.designImgSettingVue .el-select{
    width:100%;
}

.designImgSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designImgSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designImgSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designImgSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
