<template>
    <div class="designGridInputSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
    
        <div class="itemVueName"><span @click="goBack" class="pointerCalss"><i class="icon iconfont iconback back"></i></span> 明细:单行输入框</div>
         <div class="setting">
...
export default{
  name:'designGridInputSettingVue',
  components:{
  ...
  methods: {
       ...
       initConfig(_fieldId,remap){
            ...
            _config.view.display =  remap?remap.view.display:'单行输入框';
            ...
            _config.model.display = remap?remap.model.display:'单行输入框',
...
<style scoped>
.designGridInputSettingVue .setting{
    margin:10px 20px 50px 20px;
}

.designGridInputSettingVue .itemVueName{
    Font-weight: bold;
...
.designGridInputSettingVue .optionsDiv{
    font-size: 13px;
    line-height: 30px;
    height:30px;
...
.designGridInputSettingVue .optionsDiv .iconfont{
    vertical-align: middle;
}

.designGridInputSettingVue .optionsDiv .meixuanzhong{
    color:rgba(0, 0, 0, 0.65);
}

.designGridInputSettingVue .optionsDiv .xuanzhong{
    color:#409eff;
}

.designGridInputSettingVue .optionsDiv .handle{
    color:#409eff;
    cursor: move;
    font-size: 16px;
}
.designGridInputSettingVue .optionsDiv .deleteicon{
    color:#409eff;
    cursor: pointer;
    font-size: 16px;
}
.designGridInputSettingVue .optionsDiv input{
    vertical-align: middle;
    border:0px;
    outline:none;
    color:rgba(0, 0, 0, 0.65);
...
.designGridInputSettingVue  .addOptions{
...
.designGridInputSettingVue .el-select{
    width:100%;
}

.designGridInputSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designGridInputSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designGridInputSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designGridInputSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
