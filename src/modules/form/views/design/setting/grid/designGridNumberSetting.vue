<template>
    <div class="designGridNumberSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
    
         <div class="itemVueName"><span @click="goBack" class="pointerCalss"><i class="icon iconfont iconback back"></i></span> 明细:数字输入框</div>
         <div class="setting">
...
export default{
  name:'designGridNumberSettingVue',
  components:{
  ...
  created(){
      ...
      this.initItem();
      window.ecoDesignGridNumberVm = this;
  ...
  beforeDestroy(){
         console.log('销毁组件前调用');
         delete window.ecoDesignGridNumberVm;
  }
...
<style scoped>
.designGridNumberSettingVue .setting{
    margin:10px 20px 50px 20px;
}

.designGridNumberSettingVue .itemVueName{
    Font-weight: bold;
...
.designGridNumberSettingVue .optionsDiv{
    font-size: 13px;
    line-height: 30px;
    height:30px;
...
.designGridNumberSettingVue .optionsDiv .iconfont{
    vertical-align: middle;
}

.designGridNumberSettingVue .optionsDiv .meixuanzhong{
    color:rgba(0, 0, 0, 0.65);
}

.designGridNumberSettingVue .optionsDiv .xuanzhong{
    color:#409eff;
}

.designGridNumberSettingVue .optionsDiv .handle{
    color:#409eff;
    cursor: move;
    font-size: 16px;
}
.designGridNumberSettingVue .optionsDiv .deleteicon{
    color:#409eff;
    cursor: pointer;
    font-size: 16px;
}
.designGridNumberSettingVue .optionsDiv input{
    vertical-align: middle;
    border:0px;
    outline:none;
    color:rgba(0, 0, 0, 0.65);
...
.designGridNumberSettingVue  .addOptions{
...
.designGridNumberSettingVue .el-select{
    width:100%;
}

.designGridNumberSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designGridNumberSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designGridNumberSettingVue  .tip{
    font-size: 12px;
    line-height: 16px;
    color: #8b8b8b;
    font-weight: normal;
...
.designGridNumberSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designGridNumberSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
