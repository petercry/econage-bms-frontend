<template>
    <div class="designGridSelectSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
        
        <div class="itemVueName"><span @click="goBack" class="pointerCalss"><i class="icon iconfont iconback back"></i></span> 明细:下拉选框</div>
         <div class="setting">
...
export default{
  name:'designGridSelectSettingVue',
  components:{
  ...
  created(){
      ...
      this.initItem();
      window.ecoDesignGridSelectVm = this;
  ...
  methods: {
       ...
       initConfig(_fieldId,remap){
            ...
            _config.view.display =  remap?remap.view.display:'下拉选框';
            ...
            _config.model.display = remap?remap.model.display:'下拉选框',
  ...
  beforeDestroy(){
         console.log('销毁组件前调用');
         delete window.ecoDesignGridSelectVm;
  }
...
<style scoped>
.designGridSelectSettingVue .setting{
    margin:10px 20px 50px 20px;
}

.designGridSelectSettingVue .itemVueName{
    Font-weight: bold;
...
.designGridSelectSettingVue .optionsDiv{
    font-size: 13px;
    line-height: 30px;
    height:30px;
...
.designGridSelectSettingVue .optionsDiv .iconfont{
    vertical-align: middle;
}

.designGridSelectSettingVue .optionsDiv .meixuanzhong{
    color:rgba(0, 0, 0, 0.65);
}

.designGridSelectSettingVue .optionsDiv .xuanzhong{
    color:#409eff;
}

.designGridSelectSettingVue .optionsDiv .handle{
    color:#409eff;
    cursor: move;
    font-size: 16px;
}
.designGridSelectSettingVue .optionsDiv .deleteicon{
    color:#409eff;
    cursor: pointer;
    font-size: 16px;
}
.designGridSelectSettingVue .optionsDiv input{
    vertical-align: middle;
    border:0px;
    outline:none;
    color:rgba(0, 0, 0, 0.65);
...
.designGridSelectSettingVue  .addOptions{
...
.designGridSelectSettingVue .el-select{
    width:100%;
}

.designGridSelectSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designGridSelectSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designGridSelectSettingVue  .tip{
    font-size: 12px;
    line-height: 16px;
    color: #8b8b8b;
    font-weight: normal;
...
.designGridSelectSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designGridSelectSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
