                ...
                <el-tab-pane label="视图" name="view">
                    <div >
                        ...
                        <div class="ecoSettingBlock">
                            ...
                            <div>
                                <el-slider v-model="config.view.attrs.optionGrid"  :min="0" :max="5" :step="1" show-input input-size="mini" ></el-slider>
                            </div>
                        </div>
...
.designCheckboxSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designCheckboxSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designCheckboxSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designCheckboxSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
