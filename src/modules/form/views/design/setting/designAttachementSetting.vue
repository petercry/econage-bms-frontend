<template>
    <div class="designAttachmentSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
...
export default{
  name:'designAttachmentSettingVue',
  components:{
 ...
 computed:{
  ...
  methods: {
       ...
       initConfig(_fieldId,remap){
            ...
            _config.view.display =  remap?remap.view.display:'附件';
            ...
            _config.model.display = remap?remap.model.display:'附件',
...
<style scoped>
.designAttachmentSettingVue .setting{
    margin:10px 20px 50px 20px;
}

.designAttachmentSettingVue .itemVueName{
    Font-weight: bold;
...
.designAttachmentSettingVue .optionsDiv{
    font-size: 13px;
    line-height: 30px;
    height:30px;
...
.designAttachmentSettingVue .optionsDiv .iconfont{
    vertical-align: middle;
}

.designAttachmentSettingVue .optionsDiv .meixuanzhong{
    color:rgba(0, 0, 0, 0.65);
}

.designAttachmentSettingVue .optionsDiv .xuanzhong{
    color:#409eff;
}

.designAttachmentSettingVue .optionsDiv .handle{
    color:#409eff;
    cursor: move;
    font-size: 16px;
}
.designAttachmentSettingVue .optionsDiv .deleteicon{
    color:#409eff;
    cursor: pointer;
    font-size: 16px;
}
.designAttachmentSettingVue .optionsDiv input{
    vertical-align: middle;
    border:0px;
    outline:none;
    color:rgba(0, 0, 0, 0.65);
...
.designAttachmentSettingVue  .addOptions{
...
.designAttachmentSettingVue .el-select{
    width:100%;
}

.designAttachmentSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designAttachmentSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designAttachmentSettingVue .tip{
    font-size: 12px;
    line-height: 16px;
    color: #8b8b8b;
    font-weight: normal;
...
.designAttachmentSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designAttachmentSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
