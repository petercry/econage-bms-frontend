<template>
    <div class="designApprovalSettingVue designSettingVue" v-show="config.loaded1 && config.loaded2">
        <div class="itemVueName">审批意见</div>
        <div class="setting">
 ...
 computed:{
  ...
  methods: {
       ...
       initConfig(_fieldId,remap){
            ...
            this.fieldTypeArray = [];
            this.fieldTypeArray.push({id:'DECISION',desc:'DECISION'});
            ...
            _config.view.display =  remap?remap.view.display:'审批意见';
            ...
            _config.model.display = remap?remap.model.display:'审批意见',
            _config.model.field = _fieldId ;
            _config.model.fieldType =  remap?remap.model.fieldType:'DECISION';
...
<style scoped>
.designApprovalSettingVue .setting{
    margin:10px 20px 50px 20px;
}

.designApprovalSettingVue .itemVueName{
    Font-weight: bold;
...
.designApprovalSettingVue .optionsDiv{
    font-size: 13px;
    line-height: 30px;
    height:30px;
...
.designApprovalSettingVue .optionsDiv .iconfont{
    vertical-align: middle;
}

.designApprovalSettingVue .optionsDiv .meixuanzhong{
    color:rgba(0, 0, 0, 0.65);
}

.designApprovalSettingVue .optionsDiv .xuanzhong{
    color:#409eff;
}

.designApprovalSettingVue .optionsDiv .handle{
    color:#409eff;
    cursor: move;
    font-size: 16px;
}
.designApprovalSettingVue .optionsDiv .deleteicon{
    color:#409eff;
    cursor: pointer;
    font-size: 16px;
}
.designApprovalSettingVue .optionsDiv input{
    vertical-align: middle;
    border:0px;
    outline:none;
    color:rgba(0, 0, 0, 0.65);
...
.designApprovalSettingVue  .addOptions{
...
.designApprovalSettingVue .el-select{
    width:100%;
}

.designApprovalSettingVue .ecoSettingDesc .title{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designApprovalSettingVue .ecoSettingDesc .note{
    font-size: 14px;
    height: 32px;
    line-height: 32px;
    color: #8b8b8b;
...
.designApprovalSettingVue .ecoSettingDesc .switchDesc{
    font-size: 14px;
    color: #606266;
    height: 32px;
    line-height: 32px;
...
.designApprovalSettingVue .ecoSettingBlock{
    margin-bottom:10px;
}
