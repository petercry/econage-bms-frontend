...
export default{
 ...
 computed:{
  ...
  methods: {
       ...
       goSeqIndexSetting(){
             if(sysEnv == 1){
                    let url = '/wh/jsp/version3/flowform/index.html#/wfSeqIndexSetting/'+this.config.itemOperateId+'/'+this.config.seqGroupId;
                     EcoUtil.getSysvm().openDialog('自动编号设置',url,700,550,'8vh');
               }else{
