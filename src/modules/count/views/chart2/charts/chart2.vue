<template>
  <div class="chart1 chartDiv">
      <div class="chartTitle">投诉热点企业</div>
  ...
  export default {
    ...
    methods: {
      displayChart(){
        ...
        // 指定图表的配置项和数据
        var getName = window.dataObj2.char2NameArray; //['中胜涂料','天邦农化','实华化工','正义农药厂','银星化工','正义农药厂'];
        var getValue = window.dataObj2.char2ValueArray; //[1026, 865, 826, 808, 756, 720];
