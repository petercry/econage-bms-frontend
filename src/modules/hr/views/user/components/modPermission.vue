...
import {saveAccountModularConfig,getAccountModularConfig} from '../../../service/service.js'
export default{
  name:'menuConfig',
  components:{
    ecoLoading,
  ...
  mounted(){
    this.getAccountModularConfig();
  },
  methods: {
    getAccountModularConfig(){
      let id = this.$route.params.userId; 
      getAccountModularConfig(id).then(res=>{
    ...
    save(){
      ...
      saveAccountModularConfig(id,resultArr).then((res)=>{
        try {
