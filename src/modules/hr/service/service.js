...
//角色-角色定义列表
export const getRoleListByPage = function(data){
...
export const getDepartmentRoleList = function(deptId,type,data){
  return axios.get(baseUrl+'/role/def/work-view',{
      params:{
          workViewBranchDeptRtScope:deptId,
          type:type,
          page:data.page,
          rows:data.rows,
          name:data.name,
...
/*获取角色 分支机构*/
export const getRoleBrachDeptView = function(){
    return axios.get(baseUrl+'/role/def/branch-dept-view/common',{
        params:{
            time:new Date().getTime()
        }
    })
...
export const getDetpAllBranchDepView = function(){
...
// 角色同步
export const getRoleSync= function(){
    return axios.get(baseUrl+'/web-service/china-life/sync/full/role',{
        params:{
            time:new Date().getTime()
        }
    })
...
export const addRole = function(data){
    return axios.post(baseUrl+'/role/def',{
        ...
        name:data.name,
        type:data.type,
        branchDeptId:data.branchDeptId,
...
export const getRoleMember = function(data){
    return axios.get(baseUrl+'/role/def/member',{
        params:{
            role:data.roleCode,
            time:new Date().getTime()
        }
...
export const updateRoleMember = function(roleDef,array){
    return axios.post(baseUrl+'/role/def/member/'+roleDef,array,{
        headers: {'Content-Type': 'application/json;charset=UTF-8'},
        traditional:true
    })
}
...
export const deleteGroupRole= function(id,orgRoleId){
  return axios.delete(baseUrl+'/user-group/'+id+'/role-config/'+orgRoleId,{traditional:true})
}
//用户组 单个 成员配置
...
export const editDept = function(data,id){
  ...
  return axios.put(baseUrl+'/org/dept/'+id,{
    ...
    pyIdx:data.pyIdx,
    telephone:data.telephone,
    hiddenInDialog:data.hiddenInDialog,
    time:new Date().getTime()
  },{
    headers: {'Content-Type': 'application/json;charset=UTF-8'},
    traditional:true
...
export const deleteAccountRole= function(userId,id){
  return axios.delete(baseUrl+'/org/account/'+userId+'/role-config/'+id,{traditional:true})
}
...
export const changeUserLinkDept = function(userId,deptId){
  return axios.post(baseUrl+'/org/user/config/reset-user-dept-link',qs.stringify({
    "user-id":userId,
    "dept-id":deptId,
    time:new Date().getTime()
  },{arrayFormat:'repeat'}),{traditional:true})
