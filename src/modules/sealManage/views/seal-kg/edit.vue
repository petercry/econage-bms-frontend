...
import {updateSealKg,getSealKgSingle,getSealGroupAll} from '@/modules/sealManage/service/service.js'
export default{
  name:'sealKgEdit',
  components:{
  ...
  methods: {
    ...
    getData(){
      getSealKgSingle(this.$route.params.id).then(res=>{
    ...
    save(){
        this.$refs['form'].validate((valid) => {
            if (valid) {
                ...
                updateSealKg(this.form).then((res)=>{
                  try {
