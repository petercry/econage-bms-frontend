...
import {getSealGroupAll,dndSealGroup} from '@/modules/sealManage/service/service.js'
  ...
  export default{
      ...
      methods: {
        getList(){
          ...
          let orgId = '';
          getSealGroupAll(orgId).then(res=>{
        ...
        handleDragEnd(draggingNode, dropNode, dropType, ev){
          ...
          dndSealGroup(id,dndObj).then((res)=>{
            this.$refs.ecoLoadingRef.close();
            try {
              let doObj = {}
              doObj.action = 'sealTypeSortCallBack';
              doObj.close = false;
