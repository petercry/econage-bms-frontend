<template>
  <div class="">
    <div class="kn-header" >
      ...
      <div>
        编辑枚举分组
        <!-- <ecoActionBtn :ecoActionBtnFunc="updateBasicKvCategory">
...
export default {
  ...
  methods:{
    init(){
      ...
      this.beforeOrder = treeSelected.order;
    },
    updateBasicKvCategory(){
      let id = this.$route.params.id;
      let node = this.sysTree.getNode('category'+id);
          ...
          if (valid) {
            ...
            updateBasicKvCategory(id,this.form).then((res)=>{
              if (res.data&&res.data.id){
                ...
                if (this.beforeOrder != res.data.order){
