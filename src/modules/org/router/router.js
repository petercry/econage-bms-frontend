...
const orgUserSelect = r => require.ensure([], () => r(require('../views/orgUserSelect.vue')), 'hr')
...
const role = r => require.ensure([], () => r(require('../views/role/index.vue')), 'hr')
const roleAdd = r => require.ensure([], () => r(require('../views/role/add.vue')), 'hr')
const roleEdit = r => require.ensure([], () => r(require('../views/role/edit.vue')), 'hr')
