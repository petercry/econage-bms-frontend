...
import {getCustomMenuTree,getUserGroupMenuIds,saveUserGroupMenuIds} from '../../../service/service.js'
export default{
  name:'menuConfig',
  components:{
    ecoLoading,
  ...
  methods: {
    getUserGroupMenuIds(){
      ...
      getUserGroupMenuIds(id).then(res=>{
    ...
    save(){
      ...
      saveUserGroupMenuIds(id,defaultChecked).then((res)=>{
        try {
