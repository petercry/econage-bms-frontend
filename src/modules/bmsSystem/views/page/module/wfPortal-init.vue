...
<el-card  :body-style="{ padding: '0 20px'}" style="">
  <div style="position:relative;">
    <div class="homeTitle border">事项查看
    ...
    <div style="padding:20px 0;height:350px;">
      <el-card v-for="item in dataList" :key="item.id" class="wfItem cpointer" :body-style="{ padding: '12px 20px 4px'}" shadow="hover"  @click.native="goDetail(item.id,item.wfId,item.defFieldId)">
        <div class="info">
