...
<script>
  import {sysEnv} from '@/modules/bmsMmm/config/env.js'
  import {getWeatherByCityCode,getAllCity,getCurrentPositionByIp} from "@/modules/bmsSystem/service/service.js";
  import {weatherType2Icon} from "@/modules/bmsSystem/assets/js/weathertype2icon";
