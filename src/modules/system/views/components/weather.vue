...
<script>
  ...
  import {getWeatherByCityCode,getAllCity} from "../../service/service.js";
  import {weatherType2Icon} from "../../assets/js/weathertype2icon";
  ...
  export default {
      ...
      computed: {
        ...
        mounted(){
            ...
            if(sysEnv == 1){
                this.weatherIframe = '/page/weather.html';
            }else{
