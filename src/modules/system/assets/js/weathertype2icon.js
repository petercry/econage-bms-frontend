...
var weatherType2Icon = (type) => {
	...
	let classType = '';
	switch(type) {
		case wtType[0]: classType = "icon-qing";		break;
		case wtType[1]: classType = "icon-duoyun";	break;
		case wtType[2]: classType = "icon-yintian";		break;
		case wtType[3]: classType = "icon-zhenyu";		break;
		case wtType[4]: classType = "icon-leizhenyu";		break;
		case wtType[5]: classType = "icon-leizhenyubanyoubingbao";		break;
		case wtType[6]: classType = "icon-yujiaxue";		break;
		case wtType[7]: classType = "icon-xiaoyu";		break;
		case wtType[8]: classType = "icon-zhongyu";		break;
		case wtType[9]: classType = "icon-dayu";		break;
		case wtType[10]: classType = "icon-baoyu";		break;
		case wtType[11]: classType = "icon-dabaoyu";		break;
		case wtType[12]: classType = "icon-tedabaoyu";		break;
		case wtType[13]: classType = "icon-zhenxue";		break;
		case wtType[14]: classType = "icon-xiaoxue";		break;
		case wtType[15]: classType = "icon-zhongxue";		break;
		case wtType[16]: classType = "icon-daxue";		break;
		case wtType[17]: classType = "icon-baoxue";		break;
		case wtType[18]: classType = "icon-wu";		break;
		case wtType[19]: classType = "icon-dongyu";		break;
		case wtType[20]: classType = "icon-shachenbao";		break;
		case wtType[21]: classType = "icon-xiaoyu-zhongyu";		break;
		case wtType[22]: classType = "icon-zhongyu-dayu";		break;
		case wtType[23]: classType = "icon-dayubaoyu";		break;
		case wtType[24]: classType = "icon-baoyu-dabaoyu";		break;
		case wtType[25]: classType = "icon-dabaoyu-tedabaoyu";		break;
		case wtType[26]: classType = "icon-xiaoxue-zhongxue";		break;
		case wtType[27]: classType = "icon-zhongxue-daxue";		break;
		case wtType[28]: classType = "icon-daxue-baoxue";		break;
		case wtType[29]: classType = "icon-fuchen";		break;
		case wtType[30]: classType = "icon-yangsha";		break;
		case wtType[31]: classType = "icon-qiangshachenbao";		break;
		case wtType[32]: classType = "icon-mai";		break;
		default : classType = "yintian";				break;
	}
