              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <el-input placeholder="请输入内容" v-model="form.extPropsObj.resultType" clearable>
...
import {getDetailEntry,getTitleList4create,getGroupList4createByTitle,addItem,getAppList,getItemInnerInteractionModList,getItemFileFetchId,getEnumCreateEnabled,getItemHandleMethodEnum} from '@/modules/portal1/service/service.js'
...
export default{
  ...
  mounted(){
    ...
    this.getEnumCreateEnabled('APP_METHOD');
    this.getEnumCreateEnabled('MATERIAL_FORM');
    this.getEnumCreateEnabled('RESULT_DELIVERY');
    this.getEnumCreateEnabled('TIME_LIMIT');
  ...
  methods: {
    ...
    getEnumCreateEnabled(id){
      getEnumCreateEnabled(id).then(res=>{
        this[id] = res.data;
        if (id=='RESULT_DELIVERY'){
          this.form.extPropsObj.resultType=res.data.length>0?res.data[0].id:'';
        }
        if (id=='APP_METHOD'){
          this.form.extPropsObj.appType=res.data.length>0?res.data[0].id:'';
        }
      }).catch(e=>{})
    },
