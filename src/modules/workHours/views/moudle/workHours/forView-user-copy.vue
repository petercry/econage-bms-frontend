<template>
    <eco-content top="0px" bottom="0px" type="tool" class="workHours-view" style="background-color:#f5f5f5">
        <div class="forView-user">
            ...
            <eco-content top="61px" style="height:104px;" >
                <div class="searchBox">
                    <div>
                        <span>时间：</span>
                        <div class="itemInput">
                    ...
                    <div>
                        ...
                        <span>专业：</span>
                        <div class="itemInput" style="width:250px;">
                            <el-select v-model="params.activityIdArr" multiple placeholder="请选择或输入名称查询" filterable style="width:250px;">
                                <el-option
                        ...
                        <span>项目：</span>
                        <div class="itemInput" style="width:250px;">
                            <el-select filterable value-key="id" :filter-method="projectSearch" v-model="modelItem" placeholder="请选择或输入名称、编码查询" style="width:250px;" @visible-change="copyProjectList = projectList"  multiple @change="projectChange">
                                <el-option
            ...
            <eco-content bottom="0" top="165px" ref="content" style="padding:10px 15px;">
...
import {getChartByUser,getFixedChartByUser,exportChartByUser,exportChartByUserFixed} from '../../../api/workHours.js'
