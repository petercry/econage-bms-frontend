<template>
    <div class="tagSelect">
        ...
        <div class="el-customDiv" @click="!disabled?selectOrgPick():''">
            <div class="selectDiv">
                <span v-show="tags.length==0" class="placeholder" >{{placeholder}}</span>
                     ...
                     <el-popover
                        ...
                        trigger="hover"
                        @show="showPopover?getUserInfo(tag):''">
                        <el-tag
                        ...
                        <!-- <div>
                            <p style="margin:5px 0px;"><label>移动电话：</label>{{userInfo.mobilePhone}}</p>
                            <p style="margin:5px 0px;"><label>电子邮件：</label>{{userInfo.email}}</p>
                        </div> -->
                    </el-popover>
            </div>
   ...
   methods: {
            ...
            emitFunc(){
                    ...
                    (this.tags).forEach((item)=>{
                            ...
                            _oneItem.name = this.getOrgPathFilter(item.orgPath || item.name);
                            _oneItem.orgPath = item.orgPath;
            ...
            getUserInfo(tag){
                axios.get(baseUrl+'/org/user/'+tag.linkId).then((response)=>{
