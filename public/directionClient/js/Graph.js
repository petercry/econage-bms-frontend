...
{
    this.arrowUp = this.createArrow(this.triangleUp, '');
    this.arrowRight = this.createArrow(this.triangleRight, '');
    this.arrowDown = this.createArrow(this.triangleDown, '');
    this.arrowLeft = this.createArrow(this.triangleLeft,'');
    //修改
