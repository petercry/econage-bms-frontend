...
Sidebar.prototype.init = function () {
	...
	if (versionType === 'EASY') {
		let nodeList = [],
        zlist = [];
    nodeList = [ 'start', 'work', 'condition', 'end','subprocess', 'afbot'];
    zlist = [ '', '', '', '', '', '', '','',''];
    this.addImagePalette(
        ...
        dir + '/clipart/',
        '.svg',
        //['start','work','condition','cc','subprocess','afbot','abfinish','end'],['','','','','','','',''],
        nodeList,
        zlist,
        {
	...
	} else if (versionType === 'huarun') {
		this.addGeneralPaletteEco(true);
	} else if (versionType === 'PRO') {
		this.addBpmnGeneral();
		this.addBpmnSwim();
		this.addBpmnSymbol(dir, false);
	} else if (versionType.indexOf('VCA') > -1) {
		this.addVCAGeneral(dir);
	} else if (versionType === 'multiDimension') {
		this.addVCAGeneral(dir);
		this.addMultiDimensionGeneral(dir);
	} else {
		this.addVCAGeneral(dir);
 ...
 */
Sidebar.prototype.defaultImageWidth = 60;

/**
 * Specifies the height for clipart images. Default is 80.
 */
Sidebar.prototype.defaultImageHeight = 60;
	...
	if (this.enableTooltips && this.showTooltips) {
		if (this.currentElt != elt) {
			...
			let show = mxUtils.bind(this, function () {
				...
				temp[0].setValue(getVertexDescByStyle(temp[0].style));
	...
	let fns = [
	    ...
	    this.createVertexTemplateEntry('shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;', 120, 80, '', 'Callout', null, null, 'bubble chat thought speech message'),
	 	...
	 	this.addEntry(lineTags + 'edge title', mxUtils.bind(this, function () {
	    	...
	    	let cell0 = new mxCell('Label', new mxGeometry(0, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=center;verticalAlign=middle;');
		...
		this.addEntry(lineTags + 'edge title multiplicity', mxUtils.bind(this, function () {
	    	...
	    	let cell1 = new mxCell('Source', new mxGeometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=bottom;');
		...
		this.addEntry(lineTags + 'edge title multiplicity', mxUtils.bind(this, function () {
	    	...
	    	let cell2 = new mxCell('Target', new mxGeometry(1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=right;verticalAlign=bottom;');
...
Sidebar.prototype.addBpmnGeneral = function (expand) {
	let sb = this;
	let fns = [
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;compType=ecoBpmn.start;aspect=fixed;', 80, 80, 'START', '开始', null, null, 'circle'),
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;container=1;recursiveResize=0;isTask=1', 120, 60, '', '活动', null, null, 'rect rectangle box'),
		// this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', '开始/结束', null, null, 'oval ellipse state'),
		this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;container=1;recursiveResize=0;;isTask=1', 80, 80, '', '活动', null, null, 'square'),
		// this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', '联系', null, null, 'circle'),
		// this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=1;backgroundOutline=1;', 120, 60, '', '预设处理', null, null, 'process task'),
		// this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;', 80, 80, '', '决策', null, null, 'diamond rhombus if condition decision conditional question test'),
		// this.createVertexTemplateEntry('shape=actor;whiteSpace=wrap;html=1;isTask=1;', 40, 60, '', '角色', null, null, 'user person human'),
		this.createVertexTemplateEntry('html=1;whiteSpace=wrap;aspect=fixed;compType=decision;shape=isoRectangle;', 120, 80, '', '决策活动', true, null, 'rectangle rect box iso isometric'),
		this.createVertexTemplateEntry('shape=datastore;whiteSpace=wrap;compType=ecoBpmn.system;html=1;recursiveResize=0;isTask=1;', 80, 80, '', '系统', null, null, 'data store cylinder database'),
		this.createVertexTemplateEntry('shape=hexagon;html=1;whiteSpace=wrap;compType=ecoBpmn.event;perimeter=hexagonPerimeter;rounded=0;isTask=1;', 120, 80, 'EVENT', '事件', null, null, 'bpmn conversation'),
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;compType=ecoBpmn.end;aspect=fixed;', 80, 80, 'END', '结束', null, null, 'circle'),
		this.createVertexTemplateEntry('shape=stepFromTo;strokeWidth=1;compType=ecoBpmn.stepFromTo;whiteSpace=wrap;html=1;', 120, 60, '', '流程接口',null, null, 'stepFromTo'),
		this.createVertexTemplateEntry('shape=orEllipse;perimeter=ellipsePerimeter;compType=ecoBpmn.or;whiteSpace=wrap;html=1;backgroundOutline=1;', 80, 80, '', '或', null, null, 'or circle oval ellipse'),
		this.createVertexTemplateEntry('shape=sumEllipse;perimeter=ellipsePerimeter;compType=ecoBpmn.and;whiteSpace=wrap;html=1;backgroundOutline=1;', 80, 80, '', '与', null, null, 'sum circle oval ellipse'),
		this.addEntry('rectangle rect box iso isometric', function () {
			let cell = new mxCell('', new mxGeometry(0, 0, 120, 80), 'rounded=0;whiteSpace=wrap;html=1;container=1;recursiveResize=0;isTask=1');
			cell.vertex = true;
			cell.kcp = true;
			let cell1 = new mxCell('', new mxGeometry(1, 0, 60, 40), 'triangle;whiteSpace=wrap;html=1;compType=ecoBpmn.kcp;direction=south;fillColor=red;fontColor=#000;fontSize=12;cloneable=0;visible=0;rotatable=0;resizable=0;editable=0;connectable=0;editable=0;');
			cell1.vertex = true;
			cell1.setValue('KCP');
			cell1.connectable = false;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new mxPoint(-30, -20);
			cell.insert(cell1);

			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '子流程');
		}),
		// this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;compType=ecoBpmn.kcp;direction=south;fillColor=red;fontColor=#000;fontSize=12;cloneable=0;visible=0;rotatable=0;resizable=0;editable=0;connectable=0', 60, 40, 'KCP', 'KCP', null, null, 'triangle logic inverter buffer'),
		this.createVertexTemplateEntry('shape=document;whiteSpace=wrap;html=1;compType=ecoBpmn.document;boundedLbl=1;isTask=1;', 120, 80, '', '文档'),
		this.addEntry('bpmn subprocess sub process sub-process', function () {
			let cell = new mxCell('', new mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;compType=ecoBpmn.workflowSub;isTask=1;');
			cell.vertex = true;

			let cell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;cloneable=0;visible=0;rotatable=0;deletable=0;resizable=0;editable=0;outlineConnect=0;connectable=0');
			cell1.vertex = true;
			cell1.geometry.relative = true;
	...
	this.addPaletteFunctions('general', '流程图组件', true,fns);
}

Sidebar.prototype.addBpmnSymbol = function (dir) {
	let fns = [
...
Sidebar.prototype.addBpmnSwim = function (expand) {
	let fns = [];
	fns.push(this.addDataEntry('container swimlane pool horizontal', 480, 360, '水平泳道',
	...
	fns.push(this.addDataEntry('container swimlane pool horizontal', 600, 480, '垂直泳道',
	...
	this.addPaletteFunctions('swim', '泳道组件', true,fns);
}
Sidebar.prototype.addVCAGeneral = function (dir) {
	this.addStencilPalette('vca', '组件库', dir + '/arrows-vca.xml',
	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2;',null,null,null,null,[
		this.createVertexTemplateEntry('shape=step;perimeter=stepPerimeter;compType=vca.step;strokeWidth=2;strokeColor=#000000;whiteSpace=wrap;html=1;fixedSize=1;', 120, 60, '', '流程'),
		this.createVertexTemplateEntry('shape=step;perimeter=stepPerimeter;compType=vca.step;strokeWidth=2;strokeColor=#000000;direction=west;whiteSpace=wrap;html=1;fixedSize=1;', 120, 60, '', '流程')
	],null,true);
}
Sidebar.prototype.addMultiDimensionGeneral = function (expand) {
	let fns = [
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;fillColor=#2a78de;gradientColor=#003fab;shadow=1;fontSize=18;fontColor=#FFFFFF;container=1;labelPosition=center;verticalLabelPosition=middle;verticalAlign=top;spacingTop=10;fontStyle=1;recursiveResize=0;allowArrows=0;noComp=true', 640, 260, '', '矩形', null, null, 'rect rectangle box'),
		this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;direction=north;fillColor=#7ebbf7;fontStyle=1;fontColor=#FFFFFF;fontSize=18;align=center;spacingLeft=0;spacingTop=25;container=1;gradientDirection=west;gradientColor=#2a78de;strokeColor=none;shadow=1;fontStyle=1;verticalAlign=top;recursiveResize=0;allowArrows=0;noComp=true', 640, 230, '', '三角形', null, null, 'triangle logic inverter buffer')
	]
	this.addPaletteFunctions('general', '几何图形', true,fns);
}
Sidebar.prototype.addGeneralPaletteEco = function (expand) {
	// this.setCurrentSearchEntryLibrary('general', 'general');

	let fns = [
	 	this.createVertexTemplateEntry('rounded=0;fontSize=16;whiteSpace=wrap;html=1;desc=节点', 120, 60, '', 'Rectangle', null, null, 'rect rectangle box'),
	 	this.createVertexTemplateEntry('rounded=1;fontSize=16;whiteSpace=wrap;html=1;', 120, 60, '', 'Rounded Rectangle', null, null, 'rounded rect rectangle box'),
	 	// Explicit strokecolor/fillcolor=none is a workaround to maintain transparent background regardless of current style
	 	this.createVertexTemplateEntry('text;html=1;fontSize=16;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;',
 			40, 20, 'Text', 'Text', null, null, 'text textbox textarea label'),
 		this.createVertexTemplateEntry('ellipse;fontSize=16;whiteSpace=wrap;html=1;', 120, 80, '', 'Ellipse', null, null, 'oval ellipse state'),
		this.createVertexTemplateEntry('whiteSpace=wrap;fontSize=16;html=1;aspect=fixed;', 80, 80, '', 'Square', null, null, 'square'),
		this.createVertexTemplateEntry('ellipse;fontSize=16;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Circle', null, null, 'circle'),
	 	this.createVertexTemplateEntry('shape=process;fontSize=16;whiteSpace=wrap;html=1;backgroundOutline=1;', 120, 60, '', 'Process', null, null, 'process task'),
	 	this.createVertexTemplateEntry('rhombus;fontSize=16;whiteSpace=wrap;html=1;', 80, 80, '', 'Diamond', null, null, 'diamond rhombus if condition decision conditional question test'),
	 	this.createVertexTemplateEntry('shape=parallelogram;fontSize=16;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fixedSize=1;', 120, 60, '', 'Parallelogram'),
	 	this.createVertexTemplateEntry('shape=hexagon;fontSize=16;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;fixedSize=1;', 120, 80, '', 'Hexagon', null, null, 'hexagon preparation'),
		this.createVertexTemplateEntry('shape=mxgraph.bpmn.ad_hoc;fontSize=16;fillColor=#000000;html=1;outlineConnect=0;', 14, 14, '', 'Ad Hoc Marker', null, null, 'bpmn ad hoc marker'),
		this.createVertexTemplateEntry('rounded=1;fontSize=16;whiteSpace=wrap;html=1;', 120, 60, '', 'Rounded Rectangle', null, null, 'rounded rect rectangle box'),
		this.createVertexTemplateEntry('shape=mxgraph.basic.star;fontSize=16;whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2',
					80, 80, '', 'Star', null, null,
					'Star')
	];

	this.addPaletteFunctions('', '组件库', true,fns);
	// this.setCurrentSearchEntryLibrary();
};
/**
 * Adds the general palette to the sidebar.
...
Sidebar.prototype.addUmlPalette = function (expand) {
	...
	let fns = [
		...
		this.addEntry('uml activity composite state', function () {
			...
			let cell1 = new mxCell('Subtitle', new mxGeometry(0, 0, 200, 26), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;fontColor=#000000;');
			cell1.vertex = true;
			cell.insert(cell1);
		...
		this.addEntry('uml sequence self call recursion delegation activation', function () {
	 	...
	 	this.addEntry(dt + 'classifier', function () {
	 		let cell1 = new mxCell('&lt;&lt;keyword&gt;&gt;<br><b>Classifier1</b><br>{abstract}', new mxGeometry(0, 0, 140, 183),
			...
			cell1.vertex = true;
	 		let field1 = new mxCell('attributes',
	 		...
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		let field2 = new mxCell('attribute1',
	 		...
	 		field2.vertex = true;
	 		cell1.insert(field2);
	 		let field3 = new mxCell('inherited attribute2',
	 		...
	 		field3.vertex = true;
	 		cell1.insert(field3);
	 		let field4 = new mxCell('...',
	 				new mxGeometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field4.vertex = true;
	 		cell1.insert(field4);
			cell1.insert(divider.clone());
	 		let field5 = new mxCell('operations',
	 				new mxGeometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field5.vertex = true;
	 		cell1.insert(field5);
	 		let field6 = new mxCell('operation1',
	 				new mxGeometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field6.vertex = true;
	 		cell1.insert(field6);
		...
		this.createVertexTemplateEntry('shape=process;fixedSize=1;size=5;fontStyle=1;', 140, 40, 'Classifier1', 'Classifier', null, null, 'classifier'),
	 	...
	 	this.addEntry(dt + 'classifier', function () {
	 		let cell1 = new mxCell('Classifier1', new mxGeometry(0, 0, 140, 183),
			...
			cell1.vertex = true;
	 		let field1 = new mxCell('internal structure',
	 		...
	 		let cell2 = new mxCell('', new mxGeometry(0, 0, 140, 140),
	 			'strokeColor=none;fillColor=none;');
			cell2.vertex = true;
	 		cell1.insert(cell2);

	 		let field2 = new mxCell('property1',
	 		...
	 		let field3 = new mxCell('property2',
	 				new mxGeometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	    	...
	    	let assoc1 = new mxCell('connector1', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;endArrow=none;verticalAlign=middle;labelBackgroundColor=none;endSize=12;html=1;align=left;endFill=0;exitX=0.15;exitY=1;entryX=0.15;entryY=0;spacingLeft=4;');
		...
		this.createVertexTemplateEntry('fontStyle=1;', 140, 30, 'Association1', 'Association', null, null, 'association'),
	 	...
	 	this.addEntry(dt + 'classifier', function () {
	 		let cell1 = new mxCell('Instance1', new mxGeometry(0, 0, 140, 138),
			...
			cell1.insert(divider.clone());
	 		...
	 		let field2 = new mxCell('internal structure',
	 		...
	 		let cell2 = new mxCell('', new mxGeometry(0, 0, 140, 50),
	 			'strokeColor=none;fillColor=none;');
			cell2.vertex = true;
	 		cell1.insert(cell2);

	 		let field3 = new mxCell('instance2',
		...
		this.createVertexTemplateEntry('fontStyle=0;', 120, 40, 'Instance1 value', 'Instance', null, null, 'instance'),
	 	...
	 	this.addEntry(dt + 'classifier', function () {
	 		let cell1 = new mxCell('&lt;&lt;enumeration&gt;&gt;<br><b>Enum1</b>', new mxGeometry(0, 0, 140, 70),
			...
			cell1.vertex = true;
	 		let field1 = new mxCell('literal1',
	 	...
	 	this.addEntry(dt + 'classifier', function () {
	 		let cell1 = new mxCell('0..1', new mxGeometry(0, 0, 120, 50),
	 			'align=right;verticalAlign=top;spacingRight=2;');
			cell1.vertex = true;
	 		let field1 = new mxCell('Property1',
		...
		this.addEntry(dt + 'component', function () {
		    let cell1 = new mxCell('', new mxGeometry(0, 0, 140, 200), 'fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;marginBottom=0;');
		    cell1.vertex = true;

		    let cell2 = new mxCell('Component', new mxGeometry(0, 0, 140, 40), 'html=1;align=left;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell2.vertex = true;
		    cell1.insert(cell2);
		    ...
		    let cell3 = new mxCell('provided interfaces', new mxGeometry(0, 0, 140, 25), 'html=1;align=center;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell3.vertex = true;
		    cell1.insert(cell3);

		    let cell4 = new mxCell('Interface1', new mxGeometry(0, 0, 140, 25), 'html=1;align=left;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell4.vertex = true;
		    cell1.insert(cell4);

			cell1.insert(divider.clone());

		    let cell5 = new mxCell('required interfaces', new mxGeometry(0, 0, 140, 25), 'html=1;align=center;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell5.vertex = true;
		    cell1.insert(cell5);

		    let cell6 = new mxCell('Interface2', new mxGeometry(0, 0, 140, 30), 'html=1;align=left;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell6.vertex = true;
		    cell1.insert(cell6);
	 	...
	 	this.addEntry(dt + 'classifier', function () {
	 		let cell1 = new mxCell('', new mxGeometry(0, 0, 270, 230),
			...
			cell1.vertex = true;
	 		...
	 		let field1 = new mxCell('Collaboration1',
	 		...
	 		let divider1 = new mxCell('', new mxGeometry(0.145, 0, 192, 8), 'line;strokeWidth=1;fillColor=none;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;dashed=1;resizeWidth=1;');
	 		divider1.geometry.relative = true;
	 		divider1.geometry.offset = new mxPoint(0, 30);
	 		divider1.vertex = true;
	 		cell1.insert(divider1);

	 		let field2 = new mxCell('Classifier1',
	 				new mxGeometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	 		field2.geometry.relative = true;
	 		...
	 		let field3 = new mxCell('Collaboration use 1',
	    	...
	    	let assoc1 = new mxCell('property1', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;endArrow=none;verticalAlign=middle;labelBackgroundColor=none;endSize=12;html=1;align=left;endFill=0;spacingLeft=4;');
	    	assoc1.geometry.relative = true;
	    	assoc1.edge = true;
	    	field2.insertEdge(assoc1, true);
	    	field3.insertEdge(assoc1, false);
	    	cell1.insert(assoc1);
	 		...
	 		let field4 = new mxCell('Classifier2',
	 				new mxGeometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	    	...
	    	let assoc2 = new mxCell('property1', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;endArrow=none;verticalAlign=middle;labelBackgroundColor=none;endSize=12;html=1;align=left;endFill=0;spacingLeft=4;');
		...
		this.createVertexTemplateEntry('shape=folder;fontStyle=1;tabWidth=80;tabHeight=30;tabPosition=left;html=1;boundedLbl=1;', 150, 80,
	 	...
	 	this.addEntry(dt + 'package', function () {
	 		let cell1 = new mxCell('Model1', new mxGeometry(0, 0, 150, 80),
	 	...
	 	this.addEntry(dt + 'stereotype', function () {
	 		let cell1 = new mxCell('', new mxGeometry(0, 0, 160, 75),
			...
			cell1.vertex = true;
	 		let field1 = new mxCell('&lt;&lt;stereotype1&gt;&gt;',
	 		...
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		let field2 = new mxCell('stereotype property 1',
	 				new mxGeometry(0, 0, 160, 25), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field2.vertex = true;
	 		cell1.insert(field2);
	 		let field3 = new mxCell('stereotype property 2',
	 				new mxGeometry(0, 0, 160, 25), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field3.vertex = true;
	 		cell1.insert(field3);
	 	...
	 	this.addEntry(dt + 'class', function () {
	 		let cell1 = new mxCell('Class1', new mxGeometry(0, 0, 140, 79),
		...
		this.createVertexTemplateEntry('ellipse;', 50, 25,
	 	...
	 	this.addEntry(dt + 'region', function () {
	 		let cell1 = new mxCell('', new mxGeometry(60, 0, 10, 100),
	 			'line;strokeWidth=1;direction=south;html=1;dashed=1;dashPattern=20 20;');
			cell1.vertex = true;

	 		let cell2 = new mxCell('Region 1', new mxGeometry(0, 40, 60, 20),
 				'text;align=right;');
	 		cell2.vertex = true;

	 		let cell3 = new mxCell('Region 2', new mxGeometry(70, 40, 60, 20),
				'text;align=left;');
	 		cell3.vertex = true;
	 	...
	 	this.addEntry(dt + 'State', function () {
	 		let cell1 = new mxCell('State1<br>[invariant1]<br>&lt;&lt;extended/final&gt;&gt;', new mxGeometry(0, 0, 140, 176),
			...
			cell1.insert(divider.clone());
	 		...
	 		let field3 = new mxCell('behavior1',
			...
			cell1.insert(divider.clone());
	 		...
	 		let field4 = new mxCell('transition1',
	 				new mxGeometry(0, 0, 140, 25), 'fillColor=none;strokeColor=none;align=left;verticalAlign=middle;spacingLeft=5;');
	 		field4.vertex = true;
	 		cell1.insert(field4);
		...
		this.createVertexTemplateEntry('shape=umlState;rounded=1;verticalAlign=top;spacingTop=5;umlStateSymbol=collapseState;absoluteArcSize=1;arcSize=10;', 140, 60,
	 	...
	 	this.addEntry(dt + 'State', function () {
	 		let cell1 = new mxCell('State1', new mxGeometry(40, 0, 140, 50),
		...
		this.addEntry('uml association', function () {
	    	...
	    	let cell1 = new mxCell('parent', new mxGeometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=bottom;');
	    	cell1.geometry.relative = true;
	    	cell1.setConnectable(false);
	    	cell1.vertex = true;
	    	edge.insert(cell1);

	    	let cell2 = new mxCell('child', new mxGeometry(1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=right;verticalAlign=bottom;');
	    	cell2.geometry.relative = true;
	    	cell2.setConnectable(false);
	    	cell2.vertex = true;
	    	edge.insert(cell2);
		...
		this.addEntry('uml relation', function () {
	    	...
	    	let cell1 = new mxCell('0..n', new mxGeometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=top;');
	    	cell1.geometry.relative = true;
	    	cell1.setConnectable(false);
	    	cell1.vertex = true;
	    	edge.insert(cell1);

	    	let cell2 = new mxCell('1', new mxGeometry(1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=right;verticalAlign=top;');
	    	cell2.geometry.relative = true;
	    	cell2.setConnectable(false);
	    	cell2.vertex = true;
	    	edge.insert(cell2);
...
Sidebar.prototype.addBpmnPalette = function (dir, expand) {
	...
	[
		...
		this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'timer_start', 'attached').join(' '), function () {
			...
			let cell1 = new mxCell('', new mxGeometry(1, 1, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;verticalLabelPosition=bottom;verticalAlign=top;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
		...
		this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'timer_start', 'attached').join(' '), function () {
			...
			let cell1 = new mxCell('', new mxGeometry(1, 0, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;labelPosition=right;align=left;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
 ...
 * Creates a drop handler for inserting the given cells.
 */
 Sidebar.prototype.symbolList = [ 'event_bpm', 'message',
 'rule','multiple',
 'event_intermediate', 'timer',
 'message_intermediate','error',
 'cancel_intermediate','event_end',
 'terminate','message_end',
 'cancel_end','fork',
 'changguiwangguan','huchiwangguan',
 'merge','inclusive'
];
Sidebar.prototype.symbolTextList = [ '常规开始', '消息开始',
 '条件开始','多例开始',
 '常规事件','定时事件',
 '消息事件','错误事件',
 '取消事件','常规结束',
...
Sidebar.prototype.createDropHandler = function (cells, allowSplit, allowCellsInserted, bounds) {
	...
	return mxUtils.bind(this, function (graph, evt, target, x, y, force) {
		...
		if (elt == null && graph.isEnabled()) {
			...
			cells[0].setValue(getVertexDescByStyle(cells[0].style));
			let that = this;
			let taskCompNum = 0;
			if (versionType === 'PRO' || versionType === 'EASY') {
				let mxCells = graph.getChildVertices(graph.getDefaultParent());
				for (let item of mxCells) {
					if (item.isTask === 1) {
						taskCompNum++;
					}
				}
			}
			let sourceCellStyle = graph.getCellStyle(cells[0])
			if (!this.graph.isSwimlane(cells[0]) && !sourceCellStyle.noComp) {
				$.ajax({
					url: url_ + '/fetch-uid',
					type: 'get',
					async: false,
					success: function (data) {
						cells[0].setAttribute('compId',data);
						cells[0].compId = data;

						if (sourceCellStyle.compType === 'ecoBpmn.start') {
							cells[0].setValue('START');
						}
						if (sourceCellStyle.compType === 'ecoBpmn.event') {
							cells[0].setValue('EVENT');
						}
						if (sourceCellStyle.compType === 'ecoBpmn.end') {
							cells[0].setValue('END');
						}
						if (sourceCellStyle.compType === 'ecoBpmn.kcp') {
							cells[0].setValue('KCP');
						}
						if (cells[0].style.indexOf('.svg') > -1) {
							let compType = 'ecoBpmn.' + cells[0].style.substring(cells[0].style.lastIndexOf('/') + 1,cells[0].style.lastIndexOf('.svg'));
							cells[0].compType = compType;
							cells[0].isTask = 1;
							cells[0].setAttribute('compType',compType);
							cells[0].setAttribute('isTask',1);
							taskCompNum++;
						} else if (cells[0].style.indexOf('.png') > -1) {
								let compType = cells[0].style.substring(cells[0].style.lastIndexOf('/') + 1,cells[0].style.lastIndexOf('.png'));
								const noTask = ['fork',
								'changguiwangguan','huchiwangguan',
								'merge','inclusive'];
								cells[0].compType = 'ecoBpmn.' + compType;
								cells[0].setAttribute('compType','ecoBpmn.' + compType);
								cells[0].setValue(that.symbolTextList[that.symbolList.indexOf(compType)]);
								if (noTask.indexOf(compType) === -1) {
									cells[0].isTask = 1;
									cells[0].setAttribute('isTask',1);
									taskCompNum++;
								} else {
									cells[0].isTask = 0;
									cells[0].setAttribute('isTask',0);
								}
						} else {
							let compType = sourceCellStyle.compType ? sourceCellStyle.compType : sourceCellStyle.shape;
							if (compType.indexOf('vca.') === -1 && compType.indexOf('ecoBpmn.') === -1) {
								compType = 'ecoBpmn.' + compType;
							}
							cells[0].compType = compType;
							cells[0].setAttribute('compType',compType);
							let isTask = sourceCellStyle.isTask ? sourceCellStyle.isTask : 0;
							cells[0].isTask = isTask;
							cells[0].setAttribute('isTask',isTask);
							if (isTask === 1) {
								taskCompNum++;
							}
						}
						let form = {};
						let levelTypeName = 'L' + (parseInt(versionType.substring(versionType.length - 1),0) + 1) + '级';

						let code = 'L' + (parseInt(versionType.substring(versionType.length - 1),0) + 1) + '-' + new Date().getTime();
						let name = cells[0].value;
						//自动获取编号
						if (versionType.indexOf('VCA-') > -1) {
							$.ajax({
								url: url_ + '/standard/bpa/architecture-draft/generate-next-code',
								type: 'get',
								data: {
								...
								success: function (data) {
									code = data;
									if (versionType === 'VCA-L0' || versionType === 'VCA-L1' || versionType === 'VCA-L2') {
										form = {
											name: name,
											code: code,
										...
										cells[0].jsondata = JSON.stringify(form)
									} else if (versionType === 'VCA-L3' ) {
										form = {
											name: name,
											levelTypeName: levelTypeName,
											code: code,
          			...
          			linkName: '',
						...
						if (versionType === 'PRO' || versionType === 'EASY') {
							let compName,type;
							if (cells[0].compType === 'ecoBpmn.workflowSub') {
								compName = 'workflowSub';
								type = 'SUBWF';
							} else if (cells[0].compType === 'ecoBpmn.system') {
								comName = 'system';
								type = 'SYS';
							} else if (cells[0].compType === 'ecoBpmn.event') {
								comName = 'event';
								type = 'EVENT';
							} else if (cells[0].compType === 'ecoBpmn.document') {
								comName = 'document';
								type = 'DOCUMENT';
							} else {
								comName = 'task';
							...
							form = {
								id: '',
								wfId: '',
								code: (Array(4).join('0') + taskCompNum).slice(-4),
								name: name,
								dutyName: '',
								dutyDesc: '',
								assigneeList: [],
				...
				cells[0].compType = 'swim';
				cells[0].setAttribute('compType','swim');
				cells[0].isTask = 0;
				cells[0].setAttribute('isTask',0);
			}
			//每次都要刷新，为了解决泳道错位问题
			...
			if (cells.length > 0) {
				...
				if (!graph.isCellLocked(target || graph.getDefaultParent())) {
					...
					try {
						...
						if (select[0].compType.indexOf('vca.') > -1) {
							graph.updateCellStyles('fillColor','#ffffff',select);
							graph.updateCellStyles('fontColor','#00308a',select);
							graph.updateCellStyles('strokeColor','#FFFFFF',select);
							graph.updateCellStyles('strokeWidth','1',select);
							graph.updateCellStyles('fontSize','16',select);
							graph.updateCellStyles('gradientColor','#d9d9d9',select);
							graph.updateCellStyles('gradientDirection','north',select);
							graph.updateCellStyles('container','0',select);
							graph.updateCellStyles('dropTarget','0',select);
						}
...
Sidebar.prototype.createVertexTemplate = function (style, width, height, value, title, showLabel, showTitle, allowCellsInserted) {
	...
	cells[0].vertex = true;
	if (cells[0].style.indexOf('vca.') > -1) {
		let cell1 = new mxCell('', new mxGeometry(20, 0, 20, 20), 'html=1;cloneable=0;visible=0;rotatable=0;deletable=0;resizable=0;editable=0;movable=0;shape=plus;outlineConnect=0;fillColor=#2774da;strokeColor=#FFFFFF;');
		cell1.vertex = true;
		cell1.connectable = false;
		cell1.visible = false;
		cell1.compType = 'vca.linkPlus';
		cell1.geometry.relative = false;
		cell1.geometry.offset = new mxPoint(-10, -20);
		cells[0].insert(cell1);
	}
...
Sidebar.prototype.createVertexTemplateFromData = function (data, width, height, title, showLabel, showTitle, allowCellsInserted) {
	...
	if (this.graph.isSwimlane(cells[0])) {
		cells[0].style = cells[0].style + 'strokeColor=grey;fillColor=#E6E6E6;startSize=40;fontSize=14;'
		cells[0].children.forEach((element,index) => {
			element.style = element.style + 'strokeColor=grey;startSize=40;fontSize=14;'
			element.geometry.width = 200;
			element.geometry.height = 200;
			element.setValue('泳道 ' + (index + 1));
			// if(index === 0 || index === 2){
			// 	//对hover的添加按钮是否生效
			// 	element.setAttribute('ifAdd',true);
			// }
			element.compType = 'swimlane';
			element.setAttribute('compType','swimlane');
		});
	}
	return this.createVertexTemplateFromCells(cells, width, height, title, showLabel, showTitle, allowCellsInserted);
};
 ...
 */
Sidebar.prototype.addImagePalette = function (id, title, prefix, postfix, items, titles, tags,fns) {
	...
	if (versionType === 'EASY') {
		fns.push(this.addEntry('bpmn subprocess sub process sub-process', function () {
			let cell = new mxCell('', new mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;compType=ecoBpmn.workflowSub');
			cell.vertex = true;
 ...
 */
Sidebar.prototype.addStencilPalette = function (id, title, stencilFile, style, ignore, onInit, scale, tags, customFns, groupId,expand) {
