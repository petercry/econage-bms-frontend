...
ArrangePanel.prototype.addGroupOps = function (div) {
	...
	if (ss.vertices.length > 0) {
		...
		if (ui.copiedSize != null) {
			let btn2 = mxUtils.button(mxResources.get('pasteSize'), function (evt) {
...
DiagramStylePanel.prototype.addView = function (div) {
	...
	let createPreview = mxUtils.bind(this, function (commonStyle, vertexStyle, edgeStyle, graphStyle, container) {
		...
		let graph2 = new Graph(div, null, null, graph.getStylesheet());
		...
		try {
			let v1 = graph2.insertVertex(graph2.getDefaultParent(), null, 'Shape', 14, 8, 70, 40, 'strokeWidth=2;');
			let e1 = graph2.insertEdge(graph2.getDefaultParent(), null, 'Connector', v1, v1,
